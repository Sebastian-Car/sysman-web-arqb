CREATE OR REPLACE TRIGGER "BIU_SP_EMPRESAS_CONVENIO" 
  /*
        NAME              : BIU_SP_EMPRESAS_CONVENIO
        AUTHORS           : SYSMAN  SAS
        ...
        DATE MODIFIED     :
        TIME              :
        DESCRIPTION       : Trigger antes de insertar y actualizar para la tabla SP_EMPRESAS_CONVENIO, 
        ...
        */
BEFORE INSERT OR UPDATE OF NIT,DV ON SP_EMPRESAS_CONVENIO
FOR EACH ROW
BEGIN
