MERGE INTO CONSULTAS FIN USING (SELECT '000492ITarjetaKardex' INFORME ,TO_CLOB(q'[WITH SALDOSANTERIORES AS (SELECT D_MOVIMIENTO.COMPANIA,
...
group by
  LPAD(V_TARJETAKARDEX.CODIGOELEMENTO,
          ...
          5) , s$compania$s , NULL) ,
              V_TARJETAKARDEX.CODIGOELEMENTO,
              V_TARJETAKARDEX.NOMBRELARGO || ' ' || 'Unidad:' || V_TARJETA]') || TO_CLOB(q'[KARDEX.UNIDAD ,
