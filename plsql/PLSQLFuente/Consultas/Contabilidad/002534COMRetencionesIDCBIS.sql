MERGE INTO CONSULTAS FIN USING (SELECT '002534COMRetencionesIDCBIS' INFORME ,TO_CLOB(q'[SELECT 
    RETENCIONES.NOMBRE,
    ...
    COMPROBANTE_CNTRETENCION.VALOR VALOR_RETENCION
