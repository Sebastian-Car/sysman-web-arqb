MERGE INTO CONSULTAS FIN USING (SELECT '002008FlujoEfectivo' INFORME ,TO_CLOB(q'[SELECT COMPANIA,
  ANO,
  CODIGO,
  CENTRO_COSTO,
  NOMBRE,
...
AND V_PLAN_CONTABLE.ANO          between s$anioInicial$s and s$anioFinal$s
...
SELECT PLAN_FLUJO_EFECTIVO.COMPANIA,
  ...
  SUM(CASE WHEN DETALLE_COMPROBANTE_CNT.MES = 1 THEN CASE WHEN PLAN_FLUJO_EFECTIVO.NATURALEZA = 'D' 
    ...
    SUM(CASE WHEN DETALLE_COMPROBANTE_CNT.MES = 3 THEN CASE WHEN PLAN_FLUJO_EFECTIVO.NATURALEZA = 'D' 
                                                      THEN DETALLE_COMPROBANTE_CNT.VALOR_DEBITO - DETALLE_COMPROBANTE_CNT.VALOR_CREDITO 
                                                      ELSE CASE WHEN PLAN_FLUJO_EFECTIVO.NATURALEZA = 'C' 
                                                                THEN DETALLE_COMPROBANTE_CNT.VALOR_CREDITO - DETALL]') || TO_CLOB(q'[E_COMPROBANTE_CNT.VALOR_DEBITO
                                                                ELSE 0
                                                           END
                                                      END 
                                                 ELSE 0 END) SALDO3, 
   ...
   SUM(CASE WHEN DETALLE_COMPROBANTE_CNT.MES = 7 THEN CASE WHEN PLAN_FLUJO_EFECTIVO.NATURALEZA = 'D' 
                                                      THEN DETALLE_COMPROBANTE_CNT.VALOR_DEBITO - DETALLE_COMPROBANTE_CNT.VALOR_CREDITO 
                                                      ELSE CASE WHEN PLAN_FLUJO_EFECTIVO.NATURALEZA = 'C' 
                                                                THEN DETALLE_COMPROBANTE_CNT.VALO]') || TO_CLOB(q'[R_CREDITO - DETALLE_COMPROBANTE_CNT.VALOR_DEBITO
                                                                ELSE 0
                                                           END
                                                      END 
                                                 ELSE 0 END) SALDO7,
   ...
   SUM(CASE WHEN DETALLE_COMPROBANTE_CNT.MES = 11 THEN CASE WHEN PLAN_FLUJO_EFECTIVO.NATURALEZA = 'D' 
                                                      THEN DETALLE_COMPROBANTE_CNT.VALOR_DEBITO - DETALLE_COMPROBANTE_CNT.VALOR_CREDITO 
                                                      ELSE CASE WHEN PLAN_FLUJO_EFECTIVO.NATURALEZA = 'C' 
                                                                THEN DETALLE_]') || TO_CLOB(q'[COMPROBANTE_CNT.VALOR_CREDITO - DETALLE_COMPROBANTE_CNT.VALOR_DEBITO
                                                                ELSE 0
                                                           END
                                                      END 
                                                 ELSE 0 END) SALDO11,
...
AND DETALLE_COMPROBANTE_CNT.ANO   between s$anioInicial$s and s$anioFinal$s
