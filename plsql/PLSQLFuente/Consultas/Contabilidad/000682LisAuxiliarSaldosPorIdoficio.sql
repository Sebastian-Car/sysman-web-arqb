MERGE INTO CONSULTAS FIN USING (SELECT '000682LisAuxiliarSaldosPorIdoficio' INFORME ,TO_CLOB(q'[SELECT  NOCOMP,
       NOANO,
       ID,
       VD,
       VC,
...
,
    ...
    INNER JOIN C]') || TO_CLOB(q'[ENTRO_COSTO CENTRO_COSTO_SA 
