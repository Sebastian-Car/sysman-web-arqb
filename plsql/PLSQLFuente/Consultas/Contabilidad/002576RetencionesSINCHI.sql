MERGE INTO CONSULTAS FIN USING (SELECT '002576RetencionesSINCHI' INFORME ,TO_CLOB(q'[SELECT 
    RETENCIONES.NOMBRE,
...
WHERE COMPROBANTE_CNTRETENCION.COMPANIA = $P{PR_COMPANIA}
	...
	AND COMPROBANTE_CNTRETENCION.CONCEPTO NOT IN(0)											   
