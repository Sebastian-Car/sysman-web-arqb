MERGE INTO CONSULTAS FIN USING (SELECT '002600INFPLANOAUXILIARPRUEBA' INFORME ,TO_CLOB(q'[SELECT  SUBSTR(SALDOAUX.CODIGO,1,1) CLASE, 
        SALDOAUX.CODIGO, 
        SALDOAUX.DEBITO, 
        SALDOAUX.CREDITO, 
        SALDOAUX.NOMBRE,
...
WHERE LENGTH(SALDOAUX.CODIGO) <= s$digitos$s
   AND (SALDOAUX.DEBITO         + SALDOAUX.CREDITO 
      ...
      ELSE SALDOAUX.DEBITO         + SALDOAUX.CREDITO 
         ...
         + 1 
      END 
ORDER BY CASE WHEN SUBSTR(SALDOAUX.CODIGO,1,1)='0'
             THEN 'z'||SALDOAUX.CODIGO
             ELSE SALDOAUX.CODIGO
             END
