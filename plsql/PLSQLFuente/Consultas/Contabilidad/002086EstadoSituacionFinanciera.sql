MERGE INTO CONSULTAS FIN USING (SELECT '002086EstadoSituacionFinanciera' INFORME ,TO_CLOB(q'[WITH SITUACIONFINANCIERA AS (SELECT DISTINCT
     ...
     SUBSTR(CASE WHEN SUBSTR(PLAN_CONTABLE.CODIGO,1,1) = '0'   THEN 'z'
            ...
            END,1,1) CLASEORDEN,
    CASE WHEN LENGTH(1) = 1 THEN '0' ||12
         ELSE '12'
     END MES,
    ...
    GROUP BY SUBSTR(PLAN_CONTABLE.CODIGO,1,s$digitos$s), COMPANIA, CORRIENTE, SUBSTR(CASE WHEN SUBSTR(PLAN_CONTABLE.CODIGO,1,1) = '0'   THEN 'z'
            ELSE SUBSTR(PLAN_CONTABLE.CODIGO,1,1)
              || CASE WHEN PLAN_CONTABLE.CORRIENTE IN (0) THEN 'NO CORRIENTE'
                 ELSE 'CORRIENTE'
                 END || SUBSTR(PLAN_CONTABLE.CODIGO,1,s$digitos$s)
            END,1,1), CASE WHEN LENGTH(1) = 1 THEN '0' ||12
         ELSE '12'
     END,
     SUBSTR(PLAN_CONTABLE.CODIGO,1,1)
UNION 

SELECT SUBSTR(CODIGO,1,s$digitos$s) CODIGO, COMPANIA, CORRIENTE, SANTERIOR, NUEVO, CLASEORDEN, MES, SUBSTR(CODIGO,1,1) CTABAL 
        FROM( SELECT PLAN_CONTABLE.COMPANIA,
                    PLAN_CONTABLE.ANO,
CASE WHEN ((SUM ( CASE ]') || TO_CLOB(q'[WHEN PLAN_CONTABLE.CODIGO='4' THEN PLAN_CONTABLE.SALDOs$mesTrabajo$s ELSE 0 END)-
...
SUBSTR(PLAN_CONTABLE.CODIGO,1,s$digitos$s) CODIGO, 
     ...
     SUM(CASE WHEN s$mesComparar$s = 0 THEN 
          ...
          WHEN s$mesComparar$s = 13 THEN 
            PLAN_CONTABLE.SALDO13           
     END) NUEVO,
     SUBSTR(CASE WHEN SUBSTR(PLAN_CONTABLE.CODIGO,1,1) = '0'   ]') || TO_CLOB(q'[THEN 'z'
            ELSE SUBSTR(PLAN_CONTABLE.CODIGO,1,1)
              || CASE WHEN PLAN_CONTABLE.CORRIENTE IN (0) THEN 'NO CORRIENTE'
                 ELSE 'CORRIENTE'
                 END || SUBSTR(PLAN_CONTABLE.CODIGO, 1, s$digitos$s)
            END,1,1) CLASEORDEN,
             CASE WHEN LENGTH(3) = 1 THEN '0' ||12
         ELSE '12'
     END MES,
     SUBSTR(PLAN_CONTABLE.CODIGO,1,1) CTABAL
 FROM
    ...
    GROUP BY SUBSTR(PLAN_CONTABLE.CODIGO,1,s$digitos$s), COMPANIA, CORRIENTE, SUBSTR(CASE WHEN SUBSTR(PLAN_CONTABLE.CODIGO,1,1) = '0'   THEN 'z'
            ELSE SUBSTR(PLAN_CONTABLE.CODIGO,1,1)
              || CASE WHEN PLAN_CONTABLE.CORRIENTE IN (0) THEN 'NO CORRIENTE'
                 ELSE 'CORRIENTE'
                 END || SUBSTR(PLAN_CONTABLE.CODIGO,1,s$digitos$s)
            END,1,1), CASE WHEN LENGTH(3) = 1 THEN '0' ||12
         ELSE '12'
     END,
     SUBSTR(PLAN_CONTABLE.CODIGO,1,1)
     ...
     SELECT SUBSTR(CODIGO,1,s$digitos$s) CODIGO, COMPANIA, CORRIENTE, SANTERIOR, NUEVO, CLASEORDEN, MES, SUBSTR(CODIGO,1,1) CTABAL 
        FROM( SELECT PLAN_CONTABLE.COMPANIA,
                    ...
                    PCK_SYSMAN_UTL.FC_PAR('001','CUENTA DE UTILIDADES',PCK_DATOS.FC_MODULOCONTABILIDAD,SYSDATE) ELSE
                    PCK_SYSMAN_UTL.FC_PAR('001','CUENTA DE PERDIDAS',PCK_DATOS.FC_MODULOCONTABILIDAD,SYSDATE) END CODIGO,
...
SELECT CASE WHEN SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1) = '0'  THEN 'z'
         ELSE SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1)
              || CASE WHEN SITUACIONFINANCIERA.CORRIENTE NOT IN (0) THEN 'CORRIENTE'
                 ELSE 'NO CORRIENTE'
                 END || SUBSTR(SITUACIONFINANCIERA.CODIGO, 1, s$digitos$s)
     END ORDENINF,  
...
CASE WHEN SUBSTR(CASE WHEN SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1) = '0'   THEN 'z'
                      ELSE SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1)
                        || CASE WHEN SITUACIONFINANCIERA.CORRIENTE IN (0) THEN 'NO CORRIENTE'
                           ELSE 'CORRIENTE'
                            END || SITUACIONFINANCIERA.CODIGO
                        END,1,1) = '1'
              OR SUBSTR(CASE WHEN SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1) = '0'   THEN 'z'
                    ELSE SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1)
              || CASE WHEN SITUACIONFINANCIERA.CORRIENTE IN (0) THEN 'NO CORRIENTE'
                  ELSE 'CORRIENTE'
                  END
              || SITUACIONFINANCIERA.CODIGO
      END,1,1) = '2' THEN    CASE WHEN SITUACIONFINANCIERA.CORRIENTE IN (0) THEN 'NO CORRIENTE'
                             ELSE 'CORRIENTE'
                              END
         ELSE ''
     END IND,
    ...
    CASE 
        WHEN s$digitos$s = 2 AND CLASEORDEN = 3 THEN
            SUM(SITUACIONFINANCIERA.NUEVO) + (
                ...
                WHERE LENGTH(CODIGO) = s$digitos$s
                    AND CLASEORDEN = 2
            ) + SUM(SITUACIONF]') || TO_CLOB(q'[INANCIERA.NUEVO))
        ELSE SUM(SITUACIONFINANCIERA.NUEVO)
    END NUEVO,
SITUACIONFINANCIERA.CTABAL,
CASE WHEN SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1) = '0'   THEN 'z'
         ELSE SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1)
              || CASE WHEN SITUACIONFINANCIERA.CORRIENTE NOT IN (0) THEN 'CORRIENTE'
             ELSE 'NO CORRIENTE'
         END || SUBSTR(SITUACIONFINANCIERA.CODIGO, 1, s$digitos$s)
        ...
        WHEN SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1) = '3' OR SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1) = '2' THEN 
            (
                CASE   
                    ...
                    ELSE SUM(SIT]') || TO_CLOB(q'[UACIONFINANCIERA.NUEVO)
                END
            )
        ELSE 0
    END
...
GROUP BY CASE WHEN SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1) = '0'  THEN 'z'
         ELSE SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1)
              || CASE WHEN SITUACIONFINANCIERA.CORRIENTE NOT IN (0) THEN 'CORRIENTE'
                 ELSE 'NO CORRIENTE'
                 END || SUBSTR(SITUACIONFINANCIERA.CODIGO, 1, s$digitos$s)
...
CASE WHEN SUBSTR(CASE WHEN SUBSTR(SITUACIONFINANCIERA.CODIGO,1,1) = '0'   THEN 'z'
              ...
              || CASE WHEN SITUACIONFINANCIERA.CORRIENTE NOT IN (0) THEN 'CORRIENTE'
                  ...
                  END
              || SITUACIONFINANCIERA.CODIGO
      END,1,1) = '2' THEN    CASE WHEN SITUACIONFINANCIERA.CORRIENTE NOT IN (0) THEN 'CORRIENTE'
                             ELSE 'NO CORRIENTE'
                              END
         ELSE ''
     END,
...
'' 
END
HAVING (((TRUNC(SUM(SITUACIONFINANCIERA.SANTERIOR) * 100 + 0.501)) <> 0)) 
OR (((TRUNC(SUM(SITUACIONFINANCIERA.NUEVO) * 100 + 0.501)) <> 0))
ORDER BY SITUACIONFINANCIERA.CODIGO]') CONSULTA, 1 APLICACION ,TO_CLOB(q'[]') CONSULTA_OPCIONAL, NULL CREATED_BY, NULL MODIFIED_BY  FROM DUAL ) INI ON (INI.INFORME = FIN.INFORME )  WHEN MATCHED THEN  UPDATE SET FIN.CONSULTA =  INI.CONSULTA, FIN.APLICACION =  INI.APLICACION, FIN.CONSULTA_OPCIONAL =  INI.CONSULTA_OPCIONAL, FIN.MODIFIED_BY = INI.MODIFIED_BY, FIN.DATE_MODIFIED = SYSDATE  WHEN NOT MATCHED THEN  INSERT (INFORME,CONSULTA, APLICACION,CONSULTA_OPCIONAL,CREATED_BY,DATE_CREATED)  VALUES (INI.INFORME,INI.CONSULTA, INI.APLICACION,INI.CONSULTA_OPCIONAL,INI.CREATED_BY,SYSDATE);