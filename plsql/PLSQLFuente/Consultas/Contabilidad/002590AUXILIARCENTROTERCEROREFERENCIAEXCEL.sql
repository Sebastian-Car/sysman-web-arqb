MERGE INTO CONSULTAS FIN USING (SELECT '002590AUXILIARCENTROTERCEROREFERENCIAEXCEL' INFORME ,TO_CLOB(q'[SELECT
       NOANO AS NO_AÑO,
       TIPO_CPTE,
       COMPROBANTE,
       ...
       TERCERO,
       NOMBRETERCERO AS  NOMBRE_TERCERO,
       CODIGO AS CODIGO_CUENTA_CONTABLE,
       NOMBRECODIGO AS   NOMBRE_CODIGO,
       CODIGO_CENTRO,
       CODIGOREF AS CODIGO_REF ,
...
FROM ( SELECT
       ...
       CASE WHEN 0 = 1 -1 THEN SA.SALDO0
          WHEN 1 = 1 -1 THEN SA.SALDO1
          WHEN 2 = 1 -1 THEN SA.SALDO2
          WHEN 3 = 1 -1 THEN SA.SALDO3
          WHEN 4 = 1 -1 THEN SA.SALDO4
          WHEN 5 = 1 -1 THEN SA.SALDO5
          WHEN 6 = 1 -1 THEN SA.SALDO6
          WHEN 7 = 1 -1 THEN SA.SALDO7
          WHEN 8 = 1 -1 THEN SA.SALDO8
          WHEN 9 = 1 -1 THEN SA.SALDO9
          WHEN 10 = 1 -1 THEN SA.SALDO10
          WHEN 11 = 1 -1 THEN SA.SALDO11
          WHEN 12 = 1 -1 THEN SA.SALDO12
          WHEN 13 = 1 -1 THEN SA.SALDO13
     END SALDOINI,
...
FROM PLAN_CONTABLE P INNER JOIN   SALDO_AUX_CONTABLE SA
  ...
  AND P.CODIGO  = SA.CODIGO
                LEFT JOIN
   ...
   ]') || TO_CLOB(q'[                              DETALLE_COMPROBANTE_CNT.AUXILIAR,
                   ...
                   WHERE CNT.COMPANIA= s$compania$s
                      ...
                      AND DETALLE_COMPROBANTE_CNT.MES <= s$mesFinal$s
                         ...
                         AND SA.ANO            = DE.ANO
      ]') || TO_CLOB(q'[                   AND SA.CODIGO         = DE.CUENTA
...
WHERE P.COMPANIA = s$compania$s
  ...
  AND COALESCE(DE.REFERENCIA, SA.REFERENCIA) BETWEEN 's$refiInicial$s' AND 's$refFinal$s'
  AND (ABS(SA.SALDO1)
...
GROUP BY 
       ...
       VC,
       DESCRIPCION
ORDER BY CODIGO_CENTRO, TERCERO]') CONSULTA, 1 APLICACION ,TO_CLOB(q'[]') CONSULTA_OPCIONAL, NULL CREATED_BY, NULL MODIFIED_BY  FROM DUAL ) INI ON (INI.INFORME = FIN.INFORME )  WHEN MATCHED THEN  UPDATE SET FIN.CONSULTA =  INI.CONSULTA, FIN.APLICACION =  INI.APLICACION, FIN.CONSULTA_OPCIONAL =  INI.CONSULTA_OPCIONAL, FIN.MODIFIED_BY = INI.MODIFIED_BY, FIN.DATE_MODIFIED = SYSDATE  WHEN NOT MATCHED THEN  INSERT (INFORME,CONSULTA, APLICACION,CONSULTA_OPCIONAL,CREATED_BY,DATE_CREATED)  VALUES (INI.INFORME,INI.CONSULTA, INI.APLICACION,INI.CONSULTA_OPCIONAL,INI.CREATED_BY,SYSDATE);