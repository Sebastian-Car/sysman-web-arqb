MERGE INTO CONSULTAS FIN USING (SELECT '002533COMIDCBIS' INFORME ,TO_CLOB(q'[SELECT 
    ...
    (DETALLE_COMPROBANTE_CNT.TIPO_CPTE || ' - ' || TIPO_COMPROBANTE.NOMBRE) NOMBRETIPOCOMPROBANTE,
...
FROM DETALLE_COMPROBANTE_CNT
 ...
 ]') || TO_CLOB(q'[ INNER JOIN CENTRO_COSTO
