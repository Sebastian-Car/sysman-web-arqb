SELECT  PERSONAL_HISTORICO.CODIGO_ESTABLECIMIENTO  ESTABLECIMIENTO,
        ...
        SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO=940 THEN  HISTORICOS.VALOR ELSE 0 END) GASTOSREP, 
        SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO=939 THEN  HISTORICOS.VALOR ELSE 0 END) BON, 
        SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO=929 THEN  HISTORICOS.VALOR ELSE 0 END) VPT, 
        ...
        SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO=170 THEN  HISTORICOS.VALOR ELSE 0 END) PANTIG
FROM HISTORICOS 
...
WHERE HISTORICOS.COMPANIA       =  s$compania$s
  AND HISTORICOS.ID_DE_CONCEPTO IN (929,158,930,931,932,933,934,935,936,937,938,939,940,942,140,144,159,150,140,097,163,170, 160) 
