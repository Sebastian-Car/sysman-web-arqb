...
SELECT 
	...
	SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO = 116
        ...
        ELSE 0
        END) + 
	SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO = 114
        THEN HISTORICOS.VALOR
        ELSE 0
        END) + 	
	SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO = 119
        THEN HISTORICOS.VALOR
		ELSE 0
        END) - 
	SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO = 130
	...
	SUM(CASE WHEN  HISTORICOS.ID_DE_CONCEPTO = 119
        ...
        ELSE 0
        END)  SALUD_TOTAL, 
    SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO = 123
        THEN HISTORICOS.VALOR
        ELSE 0
        END)  UPC, 
    SUM(CASE WHEN  HISTORICOS.ID_DE_CONCEPTO = 369
        THEN HISTORICOS.VALOR
        ELSE 0
        END)  DTOPATRON, 
