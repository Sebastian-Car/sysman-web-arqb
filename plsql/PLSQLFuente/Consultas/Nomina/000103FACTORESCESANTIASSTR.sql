MERGE INTO CONSULTAS FIN USING (SELECT '000103FACTORESCESANTIASSTR' INFORME ,TO_CLOB(q'[SELECT   
    ...
    SUM(CASE WHEN  
         ...
         END)  PARCIAL,  
  SUM(CASE WHEN  
          ]') || TO_CLOB(q'[HISTORICOS.ID_DE_CONCEPTO = 277  
         THEN  
          HISTORICOS.VALOR  
          ELSE  
              0  
 ...
 WHERE   
  ...
  AND PERSONAL_HISTORICO.FONDO_CESANTIAS <>  'CES15'  
  AND HISTORICOS.ID_DE_CONCEPTO IN(900,901,902,903,904,905,906,907,908,909,910,911,912,913,971,269,277,972,278,278,172,175,174,483)  
 GROUP BY   
