SELECT  
    ...
    ELSE	CASE WHEN PERSONAL_HISTORICO.GRUPOCONTABLE = 'A' 
			...
			END 
    END  GRUPOCONTABLE,  
    PERSONAL_HISTORICO.FONDO_PENSION_VOL,  
    PERSONAL_HISTORICO.NOMBRE_FONDOPENSION_VOL,  
    V_FONDO_DE_PENSION_VOL.NIT, 
    SUM(CASE WHEN HISTORICOS.ID_DE_CONCEPTO = 124 
...
WHERE  
  ...
  AND HISTORICOS.ID_DE_CONCEPTO IN (124) 
