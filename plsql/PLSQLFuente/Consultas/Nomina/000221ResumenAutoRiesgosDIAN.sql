...
WHERE  
  ...
  AND TRIM(TO_CHAR(PERSONAL_HISTORICO.ANO, '0000')) || TRIM(TO_CHAR(PERSONAL_HISTORICO.MES, '00')) || TRIM(TO_CHAR(PERSONAL_HISTORICO.PERIODO, '00')) BETWEEN s$rangoInicial$s AND s$rangoInicial$s 
  AND HISTORICOS.ID_DE_CONCEPTO IN (111) 
