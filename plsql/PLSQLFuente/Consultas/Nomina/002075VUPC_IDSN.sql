...
FROM V_VOLANTES
   LEFT JOIN ENCARGOS
    ...
    AND V_VOLANTES.FECHA BETWEEN ENCARGOS.FECHAINICIO AND ENCARGOS.FECHAFINAL
    
   LEFT JOIN CATEGORIA
    ON V_VOLANTES.COMPANIA=CATEGORIA.COMPANIA
    AND V_VOLANTES.NOMBRE_DEL_CARGO_ENCARGO = CATEGORIA.NOMBRE_CATEGORIA
    AND V_VOLANTES.ANO = CATEGORIA.ANO
