MERGE INTO CONSULTAS FIN USING (SELECT '800293Formato1009' INFORME ,TO_CLOB(q'[SELECT CONFIGURACION_EXOGENA.CONCEPTO                        CONCEPTO,
  ...
  FROM SALDO_AUX_CONTABLE  INNER JOIN CONFIGURACION_EXOGENA
     ...
     INNER JOIN PLAN_CONTABLE
      ...
      AND PLAN_CONTABLE.CLASECUENTA IN ('P','E')
