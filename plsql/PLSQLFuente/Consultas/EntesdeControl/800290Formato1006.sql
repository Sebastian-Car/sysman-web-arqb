MERGE INTO CONSULTAS FIN USING (SELECT '800290Formato1006' INFORME ,TO_CLOB(q'[SELECT CONFIGURACION_EXOGENA.CONCEPTO                          CONCEPTO,
      ...
      SUM(DETALLE_COMPROBANTE_CNT.VALOR_CREDITO)              IMPUESTO_DESCONTABLE,
      SUM(CASE WHEN TIPO_COMPROBANTE.CLASE_CONTABLE IN('T') 
...
GROUP BY  CONFIGURACION_EXOGENA.CONCEPTO,                          
       ...
       TERCERO.DIGITOVERIFICACION,                       ]') || TO_CLOB(q'[     
        CASE WHEN TERCERO.TIPOID='C'
               THEN TERCERO.APELLIDO1
         END,                                                  
       CASE WHEN TERCERO.TIPOID='C'
