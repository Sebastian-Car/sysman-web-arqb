SELECT 
        PLAN_PPTAL_CONFIG.CODIGO_SIA || V_PLAN_PRESUPUESTAL.CODIGO  CODIGORUBRO,
        V_PLAN_PRESUPUESTAL.NOMBRE        NOMBRERUBRO,
        SUM(SALDOS.APROPIACIONANTERIOR)   APROPIACIONINICIAL,
        SUM(SALDOS.TRASLADO_DEBITO) 		 CREDITOSMES,
        SUM(SALDOS.TRASLADO_DEBITO_ACUM)  CREDITOSACUMULADOS,
        SUM(SALDOS.TRASLADO_CREDITO)      CONTRACREDITOSMES,
        SUM(SALDOS.TRASLADO_CREDITO_ACUM) CONTRACREDITOSACUMULADOS,
        SUM(SALDOS.APLAZAMIENTO)          APLAZAMIENTOMES,
        SUM(SALDOS.APLAZAMIENTOACUM)      APLAZAMIENTOACUMULADOS,
        SUM(SALDOS.DESAPLAZAMIENTO)       DESAPLAZAMIENTOMES,
        SUM(SALDOS.DESAPLAZAMIENTOACUM)   DESAPLAZAMIENTOACUMULADOS,
        SUM(SALDOS.REDUCCION)             REDUCCIONMES,
        SUM(SALDOS.REDUCCIONCUMULADA)     REDUCCIONACUMULADA,
        SUM(SALDOS.ADICION)               ADICIONMES,
        SUM(SALDOS.ADICIONACUMULADA)      ADICIONACUMULADA,
        SUM(SALDOS.COMPROMISOMES)         COMPROMISOSMES,
        SUM(SALDOS.COMPROMISO)            COMPROMISOSACUMULADOS,
        SUM(SALDOS.EJECUCIONMES)          PAGOSMES,
        SUM(SALDOS.EJECUCION)             PAGOSACUMULADOS,
