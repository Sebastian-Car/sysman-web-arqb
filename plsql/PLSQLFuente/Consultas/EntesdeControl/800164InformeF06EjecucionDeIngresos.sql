SELECT 
       PLAN_PPTAL_CONFIG.CODIGO_SIA || V_PLAN_PRESUPUESTAL.CODIGO CÓDIGORUBRO, 
       V_PLAN_PRESUPUESTAL.NOMBRE NOMBRERUBRO,
       SUM(SALDOS.APROPIACIONANTERIOR  ) APROPIACIONINICIAL,
       SUM(SALDOS.ADICION +SALDOS.TRASLADO_CREDITO) ADICIONMES,
       SUM(SALDOS.ADICIONACUMULADA+SALDOS.TRASLADO_CREDITO_ACUM) ADICIONACUMULADA,
       SUM(SALDOS.REDUCCION + SALDOS.TRASLADO_DEBITO) REDUCCIONMES,
       SUM(SALDOS.REDUCCIONCUMULADA +SALDOS.TRASLADO_DEBITO_ACUM) REDUCCIONACUMULADA,
       SUM(SALDOS.EJECUCIONMES         ) 	RECAUDOSMES,
       SUM(SALDOS.EJECUCION            ) RECAUDOSACUMULADOS,
