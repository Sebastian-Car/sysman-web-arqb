MERGE INTO CONSULTAS FIN USING (SELECT '800269InformeF06RelacionDeIngresos52' INFORME ,TO_CLOB(q'[SELECT CODIGO_SIA||D.CUENTA                       CODIGO_PRESUPUESTAL,  
       TO_CHAR(D.FECHA,'DD/MM/YYYY')              FECHA_DE_RECAUDO , 
...
FROM V_DETALLE_AUXILIAR_PPTAL D INNER JOIN TIPO_COMPROBPP T
  ...
  LEFT JOIN  PLAN_PPTAL_CONFIG PC
          ON  D.COMPANIA=PC.COMPANIA
            ...
            ]') || TO_CLOB(q'[    AND D.CENTRO_COSTO=PC.CENTRO_COSTO
