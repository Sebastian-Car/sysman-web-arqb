MERGE INTO CONSULTAS FIN USING (SELECT '800622AgenteICA' INFORME ,TO_CLOB(q'[SELECT DETALLE_COMPROBANTE_CNT.ANO                            VIGENCIA, 
        CASE WHEN TIPOID='C'
                THEN 'CC'
              ELSE 
         CASE WHEN TIPOID='N'
      ...
      WHERE DETALLE_COMPROBANTE_CNT.COMPANIA = s$compania$s
        ...
        CASE WHEN TIPOID='C'
         ...
         CASE WHEN TIPOID='N'
          ...
          CIUDAD.DEPARTAMENTO,                          
          PCT_APLICAR *10
           HAVING SUM(DETALLE_COMPROBANTE_CNT.VALOR_CREDITO)>0]') CONSULTA, 99 APLICACION ,TO_CLOB(q'[]') CONSULTA_OPCIONAL, NULL CREATED_BY, NULL MODIFIED_BY  FROM DUAL ) INI ON (INI.INFORME = FIN.INFORME )  WHEN MATCHED THEN  UPDATE SET FIN.CONSULTA =  INI.CONSULTA, FIN.APLICACION =  INI.APLICACION, FIN.CONSULTA_OPCIONAL =  INI.CONSULTA_OPCIONAL, FIN.MODIFIED_BY = INI.MODIFIED_BY, FIN.DATE_MODIFIED = SYSDATE  WHEN NOT MATCHED THEN  INSERT (INFORME,CONSULTA, APLICACION,CONSULTA_OPCIONAL,CREATED_BY,DATE_CREATED)  VALUES (INI.INFORME,INI.CONSULTA, INI.APLICACION,INI.CONSULTA_OPCIONAL,INI.CREATED_BY,SYSDATE);