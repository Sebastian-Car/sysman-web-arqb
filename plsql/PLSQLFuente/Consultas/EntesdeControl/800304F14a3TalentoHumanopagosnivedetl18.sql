SELECT TIPO_PAGOSIA_NOM.DESCRIPCION                       TIPO_PAGOSIA,
       PERSONAL.ID_DE_EMPLEADO                            CODIGO_EMPLEADO,
       PERSONAL_HISTORICO.APELLIDO1|| ' '||PERSONAL_HISTORICO.APELLIDO2|| ' '||PERSONAL_HISTORICO.NOMBRES   NOMBRE_EMPLEADO,
       CONCEPTOS.NOMBRE_CONCEPTO                          CONCEPTO, 
       PERSONAL_HISTORICO.ESCALAFON,
...
GROUP BY CONCEPTOS.ID_DE_CONCEPTO,CONCEPTOS.NOMBRE_CONCEPTO,TIPO_PAGOSIA_NOM.DESCRIPCION,CONCEPTOS.TIPO_PAGOSIA,
        ...
        PERSONAL_HISTORICO.APELLIDO1|| ' '||PERSONAL_HISTORICO.APELLIDO2|| ' '||PERSONAL_HISTORICO.NOMBRES,
        PERSONAL_HISTORICO.ESCALAFON,
        ESCALAFON.NOMBRE 
