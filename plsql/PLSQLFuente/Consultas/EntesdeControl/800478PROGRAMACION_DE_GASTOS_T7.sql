MERGE INTO CONSULTAS FIN USING (SELECT '800478PROGRAMACION_DE_GASTOS_T7' INFORME ,TO_CLOB(q'[SELECT CASE WHEN SUBSTR(CODIGO,1,3)='2.3'
       THEN '2.99'
       ELSE CODIGO
       END CODIGO,
       --s$nombre$s
...
NVL(INI.PROGRAMA_]') || TO_CLOB(q'[MAN,INI.PROGRAMA_PAD),     
