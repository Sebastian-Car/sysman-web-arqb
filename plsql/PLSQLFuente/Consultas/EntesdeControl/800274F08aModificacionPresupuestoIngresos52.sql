SELECT PLAN_PPTAL_CONFIG.CODIGO_SIA||DETALLE_COMPROBANTE_PPTAL.CUENTA       "Código Rubro Presupuestal",
       DETALLE_COMPROBANTE_PPTAL.NRO_DOCUMENTO                              "Acto Administrativo",
       TO_CHAR(DETALLE_COMPROBANTE_PPTAL.FECHA,'DD/MM/YYYY')                "Fecha",
       SUM(DETALLE_COMPROBANTE_PPTAL.VALOR_CREDITO)                         "Adición",
      SUM(DETALLE_COMPROBANTE_PPTAL.VALOR_DEBITO)                           "Reducción"
...
WHERE DETALLE_COMPROBANTE_PPTAL.COMPANIA     = s$compania$s
  ...
  AND PLAN_PPTAL_CONFIG.NATURALEZA IN('C')
