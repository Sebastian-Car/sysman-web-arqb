SELECT CODIGO_SIA ||RESERVA.ID                    CODIGO_RUBRO_PRESUPUESTAL,
       VP.NOMBRE                                  NOMBRE_RUBRO_PRESUPUESTAL,
      TO_CHAR( RESERVA.VIGENCIA_RESERVA)                   VIGENCIA_RESERVA,
       RESERVA_CONSTITUIDA                        VALOR_RESERVA_CONSTITUIDA,          
       ACTA                                       No_ACTA_DE_LA_MODIFICACION,
       FECHA_ACTA                                 FECHA_DEL_ACTA,                  
       MODIFICACION_RESERVA                       VALOR_MODIFICACION,
       RESERVA_CONSTITUIDA- MODIFICACION_RESERVA  VALOR_RESERVA_DEFINITIVA, 
