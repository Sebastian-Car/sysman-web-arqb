MERGE INTO CONSULTAS FIN USING (SELECT '800209F06EjecucionPresupuestaldeIngresos15' INFORME ,TO_CLOB(q'[SELECT 
       ...
       SUM(SALDOS.APROPIACIONANTERIOR  )                         "Presupuesto Inicial",
       SUM(SALDOS.ADICION              )                         " Adiciones",
       SUM(SALDOS.REDUCCION            )                         "Reducciones",
       SUM(SALDOS.EJECUCION            )                         "Total Recaudado" 
...
SELECT PLAN_PRESUPUESTAL.COMPANIA,
      ...
      SUM(SALDO_AUX_PPTAL.ADICION 
       ...
       SUM(SALDO_AUX_PPTAL.REG_CONT]') || TO_CLOB(q'[RACT 
