MERGE INTO CONSULTAS FIN USING (SELECT '800223F06EjecucionPresupuestalIngresos18' INFORME ,TO_CLOB(q'[SELECT 
       PLAN_PPTAL_CONFIG.CODIGO_SIA || V_PLAN_PRESUPUESTAL.CODIGO 			"Codigo Rubro Presupuestal", 
      ...
      SUM(SALDO_AUX_PPTAL.ADICION 
       ...
       SUM(CASE WHEN SALDO_AUX_PPTAL.MES BETWEEN  s$mesInicial$s AND  s$mesFinal$s 
         ...
         SUM(SALDO_AUX_PPTAL.TRASLADO_CREDITO 
               )  TRASLADO_CREDITO_ACU]') || TO_CLOB(q'[M,          
