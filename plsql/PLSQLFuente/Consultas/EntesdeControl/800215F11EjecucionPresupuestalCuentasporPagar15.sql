SELECT 
      PLAN_PPTAL_CONFIG.CODIGO_SIA || V_PLAN_PRESUPUESTAL.CODIGO       "|G| Cód Rubro Pptal",
        V_PLAN_PRESUPUESTAL.NOMBRE                                       "|C| Descripción",
        SUM(SALDOS.APROPIACIONANTERIOR)                                  "|D| CXP Constituida",
        'ND'                                                             "|D| Acta De Cancelación",
        SUM(SALDOS.EJECUCIONMES)                                         "|D| Pago" 
