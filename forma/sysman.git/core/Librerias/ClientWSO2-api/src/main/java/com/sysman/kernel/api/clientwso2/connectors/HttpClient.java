...
public class HttpClient {
    ...
    /**
     * Permite hacer una conexion POST a traves de una URL, un token
     * de seguridad, un objeto JSON y un formato de cabecera
     * especifico.
     */
    ...
    /**
     * Permite hacer una conexion GET a traves de una URL y un token
     * de seguridad, especifico. En caso de requerir parametros, estos
     * debera venir junto con la URL de la solicitud.
     */
    public HttpResponse doGet(String url, String token) throws IOException {
        HttpUriRequest request = new HttpGet(url);
        request.setHeader(HeaderEnum.ACCEPT.getKey(),
    ...
    /**
     * Permite hacer una conexion PUT a traves de una URL, un token de
     * seguridad, un objeto JSON y un formato de cabecera especifico.
     */
    ...
    /**
     * Permite hacer una conexion DELETE a traves de una URL y un
     * token de seguridad.
     */
