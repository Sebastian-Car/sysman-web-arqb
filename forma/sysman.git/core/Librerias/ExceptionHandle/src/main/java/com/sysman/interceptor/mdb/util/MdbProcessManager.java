package com.sysman.interceptor.mdb.util;
...
@MessageDriven(name = "MdbProcessManager", activationConfig = {
		@ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = Constans.BUSINESS_MESSAGE_QUEUE),
		@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
		@ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge") })
public class MdbProcessManager implements MessageListener {
	
	private static Logger log = Logger.getLogger(MdbProcessManager.class);
	...
	public void onMessage(Message message) {
		 try {
			...
			req.save(pro.getValueFromConfigP(Constans.ERROR_MANAGER_CONFIG_KEY), Constans.BUSINESS_METOD_INSERT, parameter );
