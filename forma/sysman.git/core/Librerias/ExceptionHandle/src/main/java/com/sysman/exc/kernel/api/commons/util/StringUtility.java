 ...
 * @version 1.0
 * 
 * Clase utilitaria que permite convertir cadenasde caracteres
...
public class StringUtility {
    ...
    /**
     * Valida si un String es diferente de nulo o vacio
     */
    ...
    /**
     * Convierte un tipo de dato String a uno Date, de acuerdo al
     * formato especificado (DateFormatEnum)
     */
    public static Date toDate(String s, DateFormatEnum dfe)
