...
import com.sysman.hojasdevida.enums.FrmFactoresControladorUrlEnum;
...
/**
 * Formulario que permite guardar los factores de riesgo.
 *
...
@ManagedBean
@ViewScoped
public class FrmFactoresControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmFactoresControlador
     */
    public FrmFactoresControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            numFormulario = GeneralCodigoFormaEnum.FRM_FACTORESCONTROLADOR.getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
        }
    ...
    public void inicializar() {
        enumBase= GenericUrlEnum.SST_FACTOR;
            reasignarOrigen();
            buscarLlave();
    ...
    public void cargarListacmbGrupo() {
        ...
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        FrmFactoresControladorUrlEnum.URL6229
                                                        .getValue());
    ...
    public void seleccionarFilacmbGrupo(SelectEvent event) {
        ...
        registro.getCampos().put("GRUPO", registroAux.getCampos().get("GRUPO"));
    }
    ...
    public void seleccionarFilacmbGrupoE(SelectEvent event) {
        Registro registroAux = (Registro) event.getObject();
        auxiliar = (String) registroAux.getCampos().get("GRUPO");
    }
