/*-
 * FrmevaccionesmejorasControlador.java
 *
 * 1.0
 * 
 * 07/02/2018
...
@ManagedBean
@ViewScoped
public class FrmevaccionesmejorasControlador extends BeanBaseDatosAcmeImpl
{
    /**
    ...
    /*
     * Variables encragadas de capturar los valores selccionados en el
     * combo de competencias
     */
    ...
    /**
     * Crea una nueva instancia de FrmevaccionesmejorasControlador
     */
    public FrmevaccionesmejorasControlador()
    {
        super();
        ...
        try
        {
            numFormulario = GeneralCodigoFormaEnum.FRMEVACCIONESMEJORAS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    {
        enumBase = GenericUrlEnum.EV_ACCIONES_MEJORA;
        buscarLlave();
        asignarOrigenDatos();
    }
    ...
    public void asignarOrigenDatos()
    {
        ...
        parametrosListado
                        .put(FrmaccionesdemejorasControladorEnum.SUCURSALEVALUADOR
                                        .getValue(),
                                        parametroRecibidos.get(
                                                        "sucursalEvaluador"));
        ...
        parametrosListado
                        .put(FrmaccionesdemejorasControladorEnum.SUCURSALEVALUADO
                                        .getValue(),
                                        parametroRecibidos.get(
                                                        "sucursalEvaluado"));
    ...
    public boolean insertarAntes()
    {
        try
        {
            ...
            consecutivo = ejbSysmanUtil.generarSiguienteConsecutivo(
                            ...
                            GenericUrlEnum.EV_ACCIONES_MEJORA.getTable(),
