/*-
 * IncapacidadesHvControlador.java
 *
 * 1.0
 * 
 * 24/01/2018
...
import com.sysman.hojasdevida.enums.IncapacidadesHvControladorUrlEnum;
...
/**
 * Formulario que permite consultar las incapacidades.
 *
...
@ManagedBean
@ViewScoped
public class IncapacidadesHvControlador extends BeanBaseDatosAcmeImpl {
    /**
    ...
    // </DECLARAR_ADICIONALES>
    /**
     * Crea una nueva instancia de IncapacidadesHvControlador
     */
    @SuppressWarnings("unchecked")
    public IncapacidadesHvControlador() {
        super();
        compania = SessionUtil.getCompania();
        parametrosEntrada = SessionUtil.getFlash();
        try {
            numFormulario = GeneralCodigoFormaEnum.INCAPACIDADESHV_CONTROLADOR
                            .getCodigo();
    ...
    public void inicializar() {
        tabla = GenericUrlEnum.INCAPACIDADES.getTable();
        buscarLlave();
        asignarOrigenDatos();
    }
    ...
    public void asignarOrigenDatos() {
        ...
        urlListado = UrlServiceUtil.getInstance().getUrlServiceByUrlByEnumID(
                        IncapacidadesHvControladorUrlEnum.URL8472.getValue());

        urlLectura = UrlServiceUtil.getInstance().getUrlServiceByUrlByEnumID(
                        IncapacidadesHvControladorUrlEnum.URL6321.getValue());
