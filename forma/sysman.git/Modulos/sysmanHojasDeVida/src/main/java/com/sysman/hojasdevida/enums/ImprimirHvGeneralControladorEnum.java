/*
 * ImprimirHvGeneralControladorEnum
 *
 * 1.0
 *
 * 09/09/2016
 ...
 */
public enum ImprimirHvGeneralControladorEnum {

    PARAM0("EMPLEADOINICIAL");

    private final String value;

    private ImprimirHvGeneralControladorEnum(String value) {
        this.value = value;
    }
