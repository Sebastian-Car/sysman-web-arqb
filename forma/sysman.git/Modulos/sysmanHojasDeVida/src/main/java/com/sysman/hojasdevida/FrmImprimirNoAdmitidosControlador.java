/*-
 * FrmImprimirNoAdmitidosControlador.java
 *
 * 1.0
 * 
 * 26/01/2018
...
import com.sysman.hojasdevida.enums.FrmImprimirNoAdmitidosControladorUrlEnum;
...
/**
 * Formulario que genera el reporte de las personas que no fueron
 * admitidas en el proceso de seleccion
 *
...
@ManagedBean
@ViewScoped
public class FrmImprimirNoAdmitidosControlador extends BeanBaseModal {
    /**
    ...
    // <DECLARAR_ATRIBUTOS>
    /**
     * Atributo que almacena el numero de covocatoria seleccionado en
     * la vista
     */
    ...
    /**
     * Lista que carga los registros de las convocatorias
     */
    private RegistroDataModelImpl listaConvocatoria;

    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmImprimirNoAdmitidosControlador
     */
    public FrmImprimirNoAdmitidosControlador() {
        super();
        compania = SessionUtil.getCompania();
        modulo = SessionUtil.getModulo();
        try {
            numFormulario = GeneralCodigoFormaEnum.FRM_IMPRIMIR_NO_ADMITIDOS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void abrirFormulario() {
        // <CODIGO_DESARROLLADO>
        /*
         * FR1650-AL_ABRIR Private Sub Form_Open(Cancel As Integer)
    ...
    public void cargarListaConvocatoria() {
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        FrmImprimirNoAdmitidosControladorUrlEnum.URL4622
                                                        .getValue());
    ...
    private void generarReporte(FORMATOS formato) {
        ...
        try {
            ...
            reemplazos.put("numeroConvocatoria", numeroConvocatoria);

            parametros.put("PR_NOMBRECOMPANIA",
                            SessionUtil.getCompaniaIngreso().getNombre());

            Reporteador.resuelveConsulta("001668ListaNoAdmitidos",
                            Integer.parseInt(modulo),
                            reemplazos, parametros);

            archivoDescarga = JsfUtil.exportarStreamed("001668ListaNoAdmitidos",
    ...
    public void seleccionarFilaConvocatoria(SelectEvent event) {
        ...
        numeroConvocatoria = SysmanFunciones
                        .nvl(registroAux.getCampos().get("NRO_CONVOCATORIA"),
                                        "")
                        .toString();
    }
