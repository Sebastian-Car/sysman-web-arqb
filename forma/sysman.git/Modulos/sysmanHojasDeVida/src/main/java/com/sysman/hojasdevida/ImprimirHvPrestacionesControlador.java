/*-
 * ImprimirHvPrestacionesControlador.java
 *
 * 1.0
 * 
 * 14/12/2017
...
import com.sysman.hojasdevida.enums.ImprimirHvPrestacionesControladorUrlEnum;
 ...
 * "Imprimir Prestaciones Sociales" en Access
 * "ImprimirHvPrestaciones", el cual es llamado desde Hojas de
 * Vida\Hojas de Vida\Informes\Prestaciones sociales hojas de vida
 *
...
@ManagedBean
@ViewScoped
public class ImprimirHvPrestacionesControlador extends BeanBaseModal {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de ImprimirHvPrestacionesControlador
     */
    public ImprimirHvPrestacionesControlador() {
        super();
        compania = SessionUtil.getCompania();
        modulo = SessionUtil.getModulo();
        cNumeroDcto = GeneralParameterEnum.NUMERO_DCTO.getName();
        try {
            numFormulario = GeneralCodigoFormaEnum.IMPRIMIR_HV_PRESTACIONES_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void cargarListaEmpleadoInicial() {
        ...
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        ImprimirHvPrestacionesControladorUrlEnum.URL001
                                                        .getValue());
    ...
    public void cargarListaEmpleadoFinal() {
        ...
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        ImprimirHvPrestacionesControladorUrlEnum.URL002
                                                        .getValue());
        Map<String, Object> param = new TreeMap<>();
        param.put(GeneralParameterEnum.COMPANIA.getName(), compania);
     ...
     *
     * Asignavalor al atributo nombreEmpleadoInicial Recarga el
     * listado de registros para seleccionar el empleado final
     *
     * @param event
     ...
     * listaEmpleadoFinal
     *
     * Asignavalor al atributo nombreEmpleadoFinal
     *
     * @param event
     * objeto que encapsula la accion proveniente de la vista
     */
    ...
    private void generarInforme(FORMATOS formato) {
        ...
        try {
            String informe = "001574HojasDeVidaPrestaciones";
