/*
 * ImprimirEliminadosControladorEnum
 *
 * 1.0
 *
 * 09/09/2016
 ...
 */
public enum ImprimirEliminadosControladorEnum {

    PARAM1("CONVOCATORIA"), PARAM0("PARAM0");

    private final String value;

    private ImprimirEliminadosControladorEnum(String value) {
        this.value = value;
    }
