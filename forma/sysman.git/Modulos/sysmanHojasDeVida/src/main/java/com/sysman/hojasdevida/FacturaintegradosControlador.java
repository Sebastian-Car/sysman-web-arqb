...
public class FacturaintegradosControlador extends BeanBaseDatosAcme {
    ...
    public void oprimirPQR() {
        ...
        String[] campos = { "idEmpleado", "numeroDocu", "sucursal",
                            "codigoPersona" };
        Object[] valores = { "415", "1049427791", "001", "00415" };

        SessionUtil.cargarModalDatosFlashCerrar("1539",
                        modulo, campos,
                        valores);
