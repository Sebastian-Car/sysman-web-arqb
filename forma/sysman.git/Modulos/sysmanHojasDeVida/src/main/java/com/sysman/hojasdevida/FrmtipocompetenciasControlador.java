/*-
 * FrmtipocompetenciasControlador.java
 *
 * 1.0
 * 
 * 16/01/2018
...
@ManagedBean
@ViewScoped
public class FrmtipocompetenciasControlador extends BeanBaseContinuoAcmeImpl
{
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmtipocompetenciasControlador
     */
    public FrmtipocompetenciasControlador()
    {
        super();
        compania = SessionUtil.getCompania();
        try
        {
            numFormulario = GeneralCodigoFormaEnum.FRM_TIPO_COMPETENCIAS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar()
    {
        ...
        enumBase = GenericUrlEnum.EV_TIPO_COMPETENCIAS;
        buscarLlave();
        reasignarOrigen();
    ...
    public boolean insertarAntes()
    {
        ...
        registro.getCampos().remove("DATE_MODIFIED");
        ...
        try
        {
            consecutivo = ejbSysmanUtil.generarSiguienteConsecutivo(
                            "EV_TIPO_COMPETENCIAS", SysmanFunciones.concatenar(
                                            "COMPANIA=''", compania, "''"),
        ...
        registro.getCampos().put("DEFINICION",
                        consecutivo);
    ...
    public boolean actualizarAntes()
    {
        ...
        registro.getCampos().remove("MODIFIED_BY");
        registro.getCampos().remove("DATE_MODIFIED");
