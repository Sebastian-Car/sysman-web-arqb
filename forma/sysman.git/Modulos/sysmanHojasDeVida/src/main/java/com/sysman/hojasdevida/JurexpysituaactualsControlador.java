/*-
 * JurexpysituaactualsControlador.java
 *
 * 1.0
 * 
 * 08/02/2018
...
/**
 * Clase encargada gestionar la experiencia en las entidades juridicas
 *
...
@ManagedBean
@ViewScoped
public class JurexpysituaactualsControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    /**
     * Variable encargada de almancenar temporalmente la sucursal del
     * tercero con naturaleza juridica
     */
    private String sucursalSociedad;
    /**
     * Variable encargada de almancenar temporalmente el nit del
     * tercero con naturaleza juridica
     */
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de JurexpysituaactualsControlador
     */
    public JurexpysituaactualsControlador() {
        super();
        ...
        try {
            numFormulario = GeneralCodigoFormaEnum.JUREXPYSITUAACTUALS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        ...
        enumBase = GenericUrlEnum.NAT_JUREXPERIENCIA;
        reasignarOrigen();
        buscarLlave();
    ...
    public boolean insertarAntes() {
        ...
        registro.getCampos().put(GeneralParameterEnum.COMPANIA.getName(),
                        compania);
        registro.getCampos().put("NITSOCIEDAD", nitSociedad);
    ...
    private Long generarConsecutivo() {
        ...
        try {
            consecutivo = ejbSysmanUtl.generarConsecutivoConValorInicial(
                            "NAT_JUREXPERIENCIA", criterio, "NUMERO", "1");
        }
