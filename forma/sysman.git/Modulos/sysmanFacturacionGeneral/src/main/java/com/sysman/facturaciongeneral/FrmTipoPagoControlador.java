...
@ManagedBean
@ViewScoped
public class FrmTipoPagoControlador extends BeanBaseContinuoAcmeImpl {
	/**
...
//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmTipoPagoControlador
	 */
	public FrmTipoPagoControlador() {
		super();
		compania = SessionUtil.getCompania();
		try {
			numFormulario = GeneralCodigoFormaEnum.FRMTIPOPAGOCONTROLADOR.getCodigo();
			validarPermisos();
		} catch (Exception ex) {
	...
	public void inicializar() {
		enumBase = GenericUrlEnum.TIPO_PAGO;
		buscarLlave();
		reasignarOrigen();
