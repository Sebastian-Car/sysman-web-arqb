/*-
 * FrmConfigurarFlujoEfectivoCgnControlador.java
 *
 * 1.0
 * 
 * 29/04/2020
...
@ManagedBean
@ViewScoped
public class  FrmConfigurarFlujoEfectivoCgnControlador  extends BeanBaseContinuoAcmeImpl{
	/**
	...
	public FrmConfigurarFlujoEfectivoCgnControlador() {
		super();
		compania = SessionUtil.getCompania();
		try {
			//2170
			numFormulario= GeneralCodigoFormaEnum.FRM_CONFIGURAR_FLUJO_EFECTIVOCGN_CONTROLADOR.getCodigo();
			validarPermisos();
			//<INI_ADICIONAL>
			//</INI_ADICIONAL>
		} catch (Exception ex) {
	...
	public void inicializar(){
		 enumBase = GenericUrlEnum.PLAN_FLUJO_EFECTIVO_CGN;
	        reasignarOrigen();
	        buscarLlave();
	...
	public boolean actualizarAntes(){
		//<CODIGO_DESARROLLADO>
		registro.getCampos().remove("NOMBRE_TIPOEFECTIVO");
