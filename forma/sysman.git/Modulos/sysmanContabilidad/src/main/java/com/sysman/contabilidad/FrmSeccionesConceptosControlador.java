/*-
 * FrmSeccionesConceptosControlador.java
 *
 * 1.0
 * 
 * 30/10/2025
...
@ManagedBean
@ViewScoped
public class FrmSeccionesConceptosControlador extends BeanBaseContinuoAcmeImpl {
	/**
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmSeccionesConceptosControlador
	 */
	public FrmSeccionesConceptosControlador() {
		super();
		compania = SessionUtil.getCompania();
		try {
			numFormulario = GeneralCodigoFormaEnum.FRM_SECCIONES_CONCEPTOS.getCodigo();
			validarPermisos();
			//<INI_ADICIONAL>
			//</INI_ADICIONAL>
		} catch (Exception ex) {
	...
	public void inicializar() {
		enumBase = GenericUrlEnum.SECCIONES_CONCEPTOS;
		reasignarOrigen();
		buscarLlave();
