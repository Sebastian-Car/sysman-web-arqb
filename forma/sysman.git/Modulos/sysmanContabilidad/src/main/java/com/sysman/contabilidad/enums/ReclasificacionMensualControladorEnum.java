/*
 * ReclasificacionMensualControladorEnum
 *
 * 1.0
 *
 * 26/06/2023
 ...
 */ 
public enum ReclasificacionMensualControladorEnum {
    ...
    KEY_TIPO("KEY_TIPO"),
    RECLASIFICAR_NIIF_MENSUAL("RECLASIFICAR_NIIF_MENSUAL"),
    D_RECLASIFICAR_NIIF_MENSUAL("D_RECLASIFICAR_NIIF_MENSUAL"),
    MSM_REGISTRO_ELIMINADO("MSM_REGISTRO_ELIMINADO");

    private final String value;

    private  ReclasificacionMensualControladorEnum(String value) {
        this.value = value;
    }
