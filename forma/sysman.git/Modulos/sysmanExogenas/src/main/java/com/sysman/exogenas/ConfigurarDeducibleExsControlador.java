/*-
 * ConfigurarDeducibleExsControlador.java
 *
 * 1.0
 * 
 * 28/12/2018
...
import com.sysman.exogenas.enums.ConfigurarDeducibleExsControladorUrlEnum;
...
@ManagedBean
@ViewScoped
public class ConfigurarDeducibleExsControlador
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de ConfigurarDeducibleExsControlador
     */
    public ConfigurarDeducibleExsControlador() {
        super();
        ...
        try {
            ...
            numFormulario = GeneralCodigoFormaEnum.CONFIGURAR_DEDUCIBLEEXS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void reasignarOrigen() {
        ...
        urlListado = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        ConfigurarDeducibleExsControladorUrlEnum.URL0001
                                                        .getValue());

        urlActualizacion = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        ConfigurarDeducibleExsControladorUrlEnum.URL0002
                                                        .getValue());
    }
