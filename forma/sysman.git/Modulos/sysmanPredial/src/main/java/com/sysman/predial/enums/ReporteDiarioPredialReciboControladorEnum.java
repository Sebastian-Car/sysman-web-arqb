/*
 * ReporteDiarioPredialReciboControladorEnum
 *
 * 1.0
 *
 * 09/09/2016
 ...
 */
public enum ReporteDiarioPredialReciboControladorEnum {

    BANCOINICIAL("BANCOINICIAL"),

    BANCOFINAL("BANCOFINAL"),
    ...
    private ReporteDiarioPredialReciboControladorEnum(String value)
    {
        this.value = value;
    }
