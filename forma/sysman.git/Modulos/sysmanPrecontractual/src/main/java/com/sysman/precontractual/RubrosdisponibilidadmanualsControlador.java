/*-
 * RubrosdisponibilidadmanualsControlador.java
 *
 * 1.0
 * 
 * 04/09/2018
...
/**
 * Controlador que administra los rubros por disponibilidad.
 *
...
@ManagedBean
@ViewScoped
public class RubrosdisponibilidadmanualsControlador
     ...
     * RubrosdisponibilidadmanualsControlador
     */
    public RubrosdisponibilidadmanualsControlador() {
        super();
        ...
        try {
            numFormulario = GeneralCodigoFormaEnum.RUBROS_DISPONIBILIDAD_MANUAL_CONTROLADOR
                            .getCodigo();
            validarPermisos();

            if (miParametros != null) {
                ridEstudio = (HashMap<String, Object>) miParametros
                                .get("ridEstudio");
                codEstudio = miParametros.get("codEstudio").toString();
                vigenciaPeriodo = miParametros.get("vigenciaPeriodo").toString();
    ...
    public void inicializar() {
        enumBase = GenericUrlEnum.ES_DISP_MANUAL;
        reasignarOrigen();
        buscarLlave();
