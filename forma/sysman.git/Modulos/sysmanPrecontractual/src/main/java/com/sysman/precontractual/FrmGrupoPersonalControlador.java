/*-
 * FrmGrupoPersonalControlador.java
...
@ManagedBean
@ViewScoped
public class  FrmGrupoPersonalControlador  extends BeanBaseContinuoAcmeImpl{
	/**
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmGrupoPersonalControlador
	 */
	
	@EJB
	private EjbSysmanUtilRemote ejbSysmanUtil;
	 
	public FrmGrupoPersonalControlador() {
		super();
		compania = SessionUtil.getCompania();
		modulo = SessionUtil.getModulo();
		try {
			//2205
			numFormulario= GeneralCodigoFormaEnum.FRM_GRUPO_PERSONAL_CONTROLADOR.getCodigo();
	...
	public void inicializar(){
		...
		enumBase=GenericUrlEnum.GRUPO_PERSONAL;
		buscarLlave();
		reasignarOrigen();
	...
	//<METODOS_BOTONES>
	//</METODOS_BOTONES>
	public void oprimirbtnDetalles() {
		Map<String, Object> param = new HashMap<>();
        param.put("CODIGO", "10");
        Direccionador direccionador = new Direccionador();
        direccionador.setNumForm(String.valueOf(GeneralCodigoFormaEnum.DGRUPOPERSONAL.getCodigo()));
	...
	public void abrirFormulario(){
		try {
			setVerCat("SI".equals(ejbSysmanUtil.consultarParametro	(
																	compania,
