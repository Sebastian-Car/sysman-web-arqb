/*-
 * ArchivocentralsControlador.java
 *
 * 1.0
 * 
 * 19/11/2019
...
import com.sysman.workflow.enums.ArchivoCentralsControladoEnum;
import com.sysman.workflow.enums.ArchivocentralsControladorUrlEnum;
...
@ManagedBean
@ViewScoped
public class  ArchivocentralsControlador  extends BeanBaseContinuoAcmeImpl{
    /**
    ...
    //</DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de ArchivocentralsControlador
     */
    public ArchivocentralsControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
        	//2133
            numFormulario= GeneralCodigoFormaEnum.ARCHIVO_CENTRALS_CONTROLADOR.getCodigo();
            validarPermisos();
            //<INI_ADICIONAL>
            //</INI_ADICIONAL>
        } catch (Exception ex) {
    ...
    public void inicializar(){
        ...
        tabla = ArchivoCentralsControladoEnum.TABLA.getValue();


        enumBase = GenericUrlEnum.ARCHIVO_CENTRAL;
        buscarLlave();
        reasignarOrigen();
    ...
    public void cargarListaSERIE(){
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        ArchivocentralsControladorUrlEnum.URL002
                                        .getValue());
    ...
    public void seleccionarFilaSERIE(SelectEvent event) {
        ...
        registro.getCampos().put("SERIE", auxiliar);
    ...
    public boolean actualizarAntes(){
        if ((registro.getLlave().containsKey("KEY_COMPANIA"))) {
