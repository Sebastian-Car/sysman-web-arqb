...
@ManagedBean
@ViewScoped
public class ImportarPqrControlador extends BeanBaseModal {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de ImportarPqrControlador
     */
    public ImportarPqrControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            // 1249
            numFormulario = GeneralCodigoFormaEnum.IMPORTAR_PQR_CONTROLADOR
                            .getCodigo();
    ...
    public void abrirFormulario() {
        // <CODIGO_DESARROLLADO>
        /*
         * FR1249-AL_ABRIR Private Sub Form_Open(Cancel As Integer)
         * formularioAbrir 74, Me.Name End Sub
         */
        // </CODIGO_DESARROLLADO>
    }
