/*
 * ActaCambioMedidorControladorEnum
 *
 * 1.0
 *
 * 09/09/2016
 ...
 */
public enum ActaCambioMedidorControladorEnum {

    TIPO("TIPO"),

    CODIGOINICIAL("CODIGOINICIAL"),

    PROBLEMAINICIAL("PROBLEMAINICIAL"),

    ACTA("ACTA");

    private final String value;

    private ActaCambioMedidorControladorEnum(String value)
    {
        this.value = value;
    }
