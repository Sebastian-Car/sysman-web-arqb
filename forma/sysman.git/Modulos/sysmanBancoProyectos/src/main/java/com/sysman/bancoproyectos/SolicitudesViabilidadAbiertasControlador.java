/*-
 * SolicitudesViabilidadAbiertasControlador.java
 *
 * 1.0
 * 
 * 25/04/2019
...
@ManagedBean
@ViewScoped
public class SolicitudesViabilidadAbiertasControlador extends BeanBaseModal {
    /**
     ...
     * SolicitudesViabilidadAbiertasControlador
     */
    public SolicitudesViabilidadAbiertasControlador() {
        super();
        compania = SessionUtil.getCompania();
        modulo = SessionUtil.getModulo();
        try {
            // 2066
            numFormulario = GeneralCodigoFormaEnum.SOLICITUDES_VIABILIDAD_ABIERTAS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void generarInforme(ReportesBean.FORMATOS formato) {
        try {
            informe = "002006SolicitudesViabilidadAbiertas";
