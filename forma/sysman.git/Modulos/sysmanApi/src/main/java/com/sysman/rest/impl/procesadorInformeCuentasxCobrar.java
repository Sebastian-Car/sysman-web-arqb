...
/**
 * Generar Informe Cuentas por cobrar
 * 
 * @version 21/12/2024
 * @author mrosero
 *
...
public class procesadorInformeCuentasxCobrar extends Procesador<Map<String, Object>, RespuestaApi> {
	 /**
    ...
    protected void ejecutar() throws NegocioExcepcion {
    	...
    	resultado = autoservicio.reporteCuentasxCobrarCremil(contexto);
