...
public class ProcesaGeneraOrganigrama
                extends Procesador<String, RespuestaApi> {
    /**
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.generarOrganigrama(contexto);
