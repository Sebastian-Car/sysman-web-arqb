...
/**
 * Procesador de solicitudes de actualizacion de detalles de
 * comprobantes Cnt
 * 
...
public class ProcesaActualizacionDetalleComprobanteCnt extends
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.actualizarDetalleComprobanteCnt(contexto);
    }
