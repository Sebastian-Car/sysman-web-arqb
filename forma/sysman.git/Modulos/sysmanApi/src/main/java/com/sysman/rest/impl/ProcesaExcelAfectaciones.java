...
public class ProcesaExcelAfectaciones
                extends Procesador<ParametrosExcelAfectaciones, RespuestaApi> {
    /**
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.generaReporteAfectaciones(contexto);
