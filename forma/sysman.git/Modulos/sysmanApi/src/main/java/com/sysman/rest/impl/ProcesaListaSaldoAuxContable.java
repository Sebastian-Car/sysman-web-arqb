...
public class ProcesaListaSaldoAuxContable extends Procesador<Map<String, Object>, RespuestaApi> {
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.obtenerListaSaldoAuxContable(contexto);
    }
