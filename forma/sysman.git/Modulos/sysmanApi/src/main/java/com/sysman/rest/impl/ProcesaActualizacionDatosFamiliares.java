...
/**
 * Procesador de solicitudes de Actualizaci&oacute;n de datos
 * familiares.
 * 
 ...
 *
 */
public class ProcesaActualizacionDatosFamiliares extends
                Procesador<ParametrosEntradaDatosFamiliares, Respuesta> {
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio
                        .solicitarActualizacionDatosFamiliares(contexto);
    }
