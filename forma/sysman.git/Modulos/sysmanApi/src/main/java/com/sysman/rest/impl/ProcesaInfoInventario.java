...
/**
 * Procesador de informacion de inventario por funcionario
 *
 * @version 1.0, 13/10/2021
 * @author 
 */
@Named("procesaInfoInventario")
@Ejecutor(tipo = COMPONENTE_PROCESSOR)
public class ProcesaInfoInventario
                extends Procesador<Map<String, Object>, RespuestaApi>
{
    ...
    public void ejecutar() throws NegocioExcepcion
    {
        ...
        resultado = autoservicio.infoInventario(contexto);
    }
