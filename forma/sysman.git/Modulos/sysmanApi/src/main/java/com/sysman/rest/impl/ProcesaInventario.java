...
/**
 * Procesador de inventario individual
 *
 * @version 1.0, 13/11/2018
 * @author mzanguna
 */
@Ejecutor(tipo = COMPONENTE_PROCESSOR)
public class ProcesaInventario
                extends Procesador<ParametrosEntradaInventario, RespuestaApi>
{
    ...
    public void ejecutar() throws NegocioExcepcion
    {
        ...
        resultado = autoservicio.generarInventarioIndividual(contexto);
    }
