...
/**
 * Procesador de solicitudes de insercion de detalles de comprobantes
 * Cnt
 * 
...
public class ProcesaInsercionDetalleComprobanteCnt extends
                Procesador<ParametrosDetalleComprobanteCnt, RespuestaApi> {
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.insertarDetalleComprobanteCnt(contexto);
    }
