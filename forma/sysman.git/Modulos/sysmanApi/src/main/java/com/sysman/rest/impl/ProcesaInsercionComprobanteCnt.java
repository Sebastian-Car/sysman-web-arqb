...
/**
 * Procesador de solicitudes de insercion de comprobantes Cnt
 * 
...
public class ProcesaInsercionComprobanteCnt extends
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.insertarComprobanteCnt(contexto);
    }
