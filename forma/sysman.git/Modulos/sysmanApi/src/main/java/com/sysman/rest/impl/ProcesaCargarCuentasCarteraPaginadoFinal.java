...
public class ProcesaCargarCuentasCarteraPaginadoFinal
                extends Procesador<Map<String, Object>, RespuestaApiPagArqC> {
    /**
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.cargarCuentasCarteraPagFinal(contexto);
    ...
    @Override
    public RespuestaApiPagArqC getResultado() {
        return resultado;
    }
