...
/**
 * Procesador de solicitudes de actualizacion de comprobantes Cnt
 * 
...
public class ProcesaActualizacionComprobanteCntAnulado extends
                Procesador<ParametrosComprobanteCnt, RespuestaApi> {
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.actualizarComprobanteCntAnulado(contexto);
    }
