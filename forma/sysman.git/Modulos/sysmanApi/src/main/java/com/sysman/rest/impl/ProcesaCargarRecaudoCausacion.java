...
/**
 * Cargar Consecutivo Comprobante Cnt
 * 
 * @version 22/01/2020
 * @author eamaya
 *
...
public class ProcesaCargarRecaudoCausacion
                extends Procesador<ParametrosRecuadoCausacion, RespuestaApi> {
    /**
    ...
    protected void ejecutar() throws NegocioExcepcion {
        ...
        resultado = autoservicio.cargarRecaudoCausacion(contexto);
