 ...
 */
public enum BasesNovedadesControladorEnum {
    TIPO("TIPO"),
    ...
    PATRONALPENSION("APORTEPATRONALPENSION"),

    EMPLEADOPENSION("APORTEEMPLEADOPENSION"),

    FSP("FSP"),

    FSPSUBSISTENCIA("FSPSUBSISTENCIA"),

    FSPADICIONAL("FSPADICIONAL"),

    PATRONALSALUD("APORTEPATRONALSALUD"),

    EMPLEADOSALUD("APORTEEMPLEADOSALUD");

    private final String value;

    private BasesNovedadesControladorEnum(String value)
    {
        this.value = value;
    }
