/*-
 * FrmlistresumaportessaludunifControlador.java
 *
 * 1.0
 * 
 * 30/09/2020
...
@ManagedBean
@ViewScoped
public class  FrmlistresumaportessaludunifControlador extends BeanBaseModal{
	/**
	...
	/**
	 * variable que almacena la lista proceso
	 */
	private List<Registro> listaAno;
	/**
	 * variable que almacena la lista año
	 */
	private List<Registro> listaMes;
	/**
	 * variable que almacena la lista mes
	 */
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmlistresumaportessaludunifControlador
	 */
	public FrmlistresumaportessaludunifControlador() {
		super();
		...
		try {
			//2193
			numFormulario = GeneralCodigoFormaEnum.FRM_LIST_RESUMA_PORTESSALUD_UNIF_CONTROLADOR.getCodigo();
			validarPermisos();
			//<INI_ADICIONAL>
			//</INI_ADICIONAL>
		} catch (Exception ex) {
	...
	public void generarReporte(FORMATOS formatos) {
		...
		try {	
			...
			String reporte = "002148RESUMENMENSUALAPORTESSALUD";
