 ...
 */
public enum PrestamosDiferidosControladorUrlEnum {
    ...
    URL5724("PERIODOTRABAJOCONTROLADORURL5724", "151001"),

    URL5725("PERIODOTRABAJOCONTROLADORURL5725", "210147");

    private final String key;
    private final String value;

    private PrestamosDiferidosControladorUrlEnum(String key, String value) {
        this.key = key;
        this.value = value;
    }
