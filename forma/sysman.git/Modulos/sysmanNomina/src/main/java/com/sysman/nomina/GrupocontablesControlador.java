/*-
 * GrupocontablesControlador.java
 *
 * 1.0
 * 
 * 06/03/2023
...
@ManagedBean
@ViewScoped
public class GrupocontablesControlador extends BeanBaseContinuoAcmeImpl {
	/**
	...
	/**
	 * Crea una nueva instancia de GrupocontablesControlador
	 */
	public GrupocontablesControlador() {
		super();
		try {
			compania = SessionUtil.getCompania();
			numFormulario = GeneralCodigoFormaEnum.FR_GRUPO_CONTABLE.getCodigo();
			validarPermisos();
		} catch (Exception ex) {
	...
	public void inicializar() {
		enumBase = GenericUrlEnum.GRUPO_CONTABLE;
		buscarLlave();
		reasignarOrigen();
	...
	public boolean actualizarAntes() {
		...
		registro.getCampos().remove("PARAMETRO_RELACIONADO");
		return true;
		// </CODIGO_DESARROLLADO>
	}
	...
	public boolean actualizarDespues() {
		// <CODIGO_DESARROLLADO>
		JsfUtil.agregarMensajeAlertaDialogo(idioma.getString("TB_TB4420"));
		return true;
		// </CODIGO_DESARROLLADO>
	}
