/*-
 * FrmlistconceptosnominapersonaControlador.java
 *
 * 1.0
 * 
 * 30/09/2020
...
@ManagedBean
@ViewScoped
public class  FrmlistconceptosnominapersonaControlador extends BeanBaseModal{
	/**
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmlistconceptosnominapersonaControlador
	 */
	public FrmlistconceptosnominapersonaControlador() {
		super();
	...
	public void generarReporte(FORMATOS formatos) {
		...
		try {	
			...
			String reporte = "002150RESUMENCONCEPTOSNOMINAPORPERSONA";
