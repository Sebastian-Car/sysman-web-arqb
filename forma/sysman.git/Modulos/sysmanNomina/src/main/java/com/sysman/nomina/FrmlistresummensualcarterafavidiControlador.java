/*-
 * FrmlistresummensualcarterafavidiControlador.java
 *
 * 1.0
 * 
 * 30/09/2020
...
@ManagedBean
@ViewScoped
public class  FrmlistresummensualcarterafavidiControlador extends BeanBaseModal{
	/**
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmlistresummensualcarterafavidiControlador
	 */
	public FrmlistresummensualcarterafavidiControlador() {
		super();
	...
	public void generarReporte(FORMATOS formatos) {
		...
		try {	
			...
			String reporte = "002145FAVIDICARTERA";
