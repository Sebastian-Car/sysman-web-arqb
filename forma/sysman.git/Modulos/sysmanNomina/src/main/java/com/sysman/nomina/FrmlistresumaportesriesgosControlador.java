/*-
 * FrmlistresumaportesriesgosControlador.java
 *
 * 1.0
 * 
 * 30/09/2020
 ...
 * 
 * 
 * @author dcastiblanco,se realizan modificaciones de alertas de sonar 
 * y se adiciona el general
 * @version 2, 26/11/2020
 */
@ManagedBean
@ViewScoped
public class  FrmlistresumaportesriesgosControlador extends BeanBaseModal{
	/**
	...
	//<DECLARAR_ATRIBUTOS>
	/**
	 * constante que almacna la compania
	 */
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmlistresumaportesriesgosControlador
	 */
	public FrmlistresumaportesriesgosControlador() {
		super();
		...
		try {
			//2192
			numFormulario = GeneralCodigoFormaEnum.FRM_LIST_RESUMAPORTES_RIESGOS_CONTROLADOR.getCodigo();
			validarPermisos();
		} catch (Exception ex) {
	...
	public void generarReporte(FORMATOS formatos) {
		...
		try {	
			...
			String reporte = "002147RESUMENMENSUALAPORTESRIESGOS";
			...
			parametros.put("PR_NOMBRE_COMPANIA", SessionUtil.getCompaniaIngreso().getNombre());
