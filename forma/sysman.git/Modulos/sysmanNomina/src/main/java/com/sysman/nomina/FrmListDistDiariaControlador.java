/*-
 * FrmListDistDiariaControlador.java
 *
 * 1.0
 * 
 * 10/10/2024
...
@ManagedBean
@ViewScoped
public class  FrmListDistDiariaControlador extends BeanBaseModal{
	/**
	...
	/**
	 * Crea una nueva instancia de FrmListDistDiariaControlador
	 */
	public FrmListDistDiariaControlador() {
		super();
	...
	public void generarInforme(FORMATOS formato)  {
		try {
			...
			if(parametro.equals("SI")) {
				reporte = "002634DistribucionpersonalDiariaAux";
			}else {
				reporte = "002633Distribucionpersonaldiaria";
			}			

			Reporteador.resuelveConsulta("002633Distribucionpersonaldiaria", Integer.parseInt(modulo), reemplazos, parametros);
