/*-
 * FrmInformePensionadosVigenciaControlador.java
 *
 * 1.0
 * 
 * 21/04/2021
 ...
 * @author gfigueredo
 * Se comenta para que sea integrado, debido a que en el commit fa182aa54122c3ba7420aba67c41ff0ae96e4265 se
 * anexaron.
 * 
 */
@ManagedBean
@ViewScoped
public class FrmInformePensionadosVigenciaControlador extends BeanBaseModal {
	/**
	...
	// <DECLARAR_ATRIBUTOS>
	/**
	 * Variable utilizada para almacenar el dato de proceso.
	 */
	private String proceso;
	/**
	 * Variable utilizada para almacenar el dato de año inicial
	 */
	private String ano1;
	/**
	 * Varible utilizada para almacenar el dato de mes incial
	 */
	private String mes1;
	/**
	 * Variable utilizada para almacenar eldato de periodo inicial
	 */
	private String periodo1;
	/**
	 * Variable utilizada para almacenar el dato de año final
	 */
	private String ano2;
	/**
	...
	/**
	 * Lista que almacena los datos de año inicial
	 */
	private List<Registro> listaAno1;
	/**
	 * Lista que almacena los datos de año final
	 */
	...
	// </DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmInformePensionadosVigenciaControlador
	 */
	public FrmInformePensionadosVigenciaControlador() {
		super();
					...
					.toListRegistro(
							requestManager.getList(
									...
									.getUrlServiceByUrlByEnumID(
											PeriodoTrabajoControladorUrlEnum.URL4058.getValue())
									.getUrl(),
									param));
			...
			listaAno1 = RegistroConverter
					.toListRegistro(
							requestManager.getList(
									UrlServiceUtil.getInstance()
									.getUrlServiceByUrlByEnumID(
											PeriodoTrabajoControladorUrlEnum.URL4735.getValue())
									.getUrl(),
									param));
		} catch (SystemException e) {
			JsfUtil.agregarMensajeError(e.getMessage());
			...
			listaMes1 = RegistroConverter
					.toListRegistro(
							requestManager.getList(
									UrlServiceUtil.getInstance()
									.getUrlServiceByUrlByEnumID(
											PeriodoTrabajoControladorUrlEnum.URL5723.getValue())
									.getUrl(),
									param));
		} catch (SystemException e) {
			logger.error(e.getMessage(), e);
			...
			listaPeriodo1 = RegistroConverter
					.toListRegistro(
							requestManager.getList(
									UrlServiceUtil.getInstance()
									.getUrlServiceByUrlByEnumID(
											PeriodoTrabajoControladorUrlEnum.URL7274.getValue())
									.getUrl(),
									param));
		} catch (SystemException e) {
			JsfUtil.agregarMensajeError(e.getMessage());
	...
	public void generarReporte(FORMATOS formatos) {
		...
		try {
			...
			String reporte = "002242INFORMACIONPENSIONADOS2017";
