/*-
 * FrmFactoresvacacionesdefinitivasControlador.java
 *
 * 1.0
 * 
 * 10/09/2020
...
/**
 * Fromulario para la impresión de informe de factores 
 * de vacaciones.
 *
...
@ManagedBean
@ViewScoped
public class  FrmFactoresvacacionesdefinitivasControlador extends BeanBaseModal{
    /**
...
private String periodo;
    /**
     * variable que almacen al periodo
     */
...
private EjbSysmanUtilRemote ejbSysmanUtil;
     ...
     */
    public FrmFactoresvacacionesdefinitivasControlador() {
  super();
        ...
        try { 
            //2184
            numFormulario = GeneralCodigoFormaEnum.FRM_FACTORES_VACACIONES_DEFINITIVAS_CONTROLADOR.getCodigo();
            validarPermisos();
        } catch (Exception ex) {
                        ...
                        .toListRegistro(requestManager.getList(
                                        UrlServiceUtil.getInstance()
                                                        .getUrlServiceByUrlByEnumID(
                                                                        FrmFactoresvacacionesdefinitivasControladorUrlEnum.URL4061.getValue())
                                                        .getUrl(),
                                        param));
    ...
    try {
            listaMes1 = RegistroConverter
                            .toListRegistro(requestManager.getList(
                                            UrlServiceUtil.getInstance()
                                                            .getUrlServiceByUrlByEnumID(
                                                                            FrmFactoresvacacionesdefinitivasControladorUrlEnum.URL4062.getValue())
                                                            .getUrl(),
                                            param));
    } catch (SystemException e) {
            logger.error(e.getMessage(), e);
    ...
    try {
        listaPeriodo1 = RegistroConverter
                            .toListRegistro(requestManager.getList(
                                            UrlServiceUtil.getInstance()
                                                            .getUrlServiceByUrlByEnumID(
                                                                            FrmFactoresvacacionesdefinitivasControladorUrlEnum.URL4063.getValue())
                                                            .getUrl(),
                                            param));
    } catch (SystemException e) {
            logger.error(e.getMessage(), e);
...
public void generarInforme(ReportesBean.FORMATOS formato){
    try {
                 ...
                 // MANEJO DE PARAMETROS DEL REPORTE
                    Reporteador.resuelveConsulta("002135FACTORESVACACIONESDEFINITIVASIDI",
                    ...
                    parametros.put("PR_OBSERVACION", observaciones);
                    ...
                    archivoDescarga = JsfUtil.exportarStreamed(
                                    "002135FACTORESVACACIONESDEFINITIVASIDI", parametros,
