/*-
 * FrmlistresumaportespensionunifControlador.java
 *
 * 1.0
 * 
 * 30/09/2020
...
@ManagedBean
@ViewScoped
public class  FrmlistresumaportespensionunifControlador extends BeanBaseModal{
	/**
	...
	/**
	 * variable que almacena la lista de año
	 */
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmlistresumaportespensionunifControlador
	 */
	public FrmlistresumaportespensionunifControlador() {
		super();
		...
		try {
			//2191
			numFormulario = GeneralCodigoFormaEnum.FRM_LIST_RESUMA_PORTES_PENSIONUNIF_CONTROLADOR.getCodigo();
			validarPermisos();
		} catch (Exception ex) {
	...
	public void generarReporte(FORMATOS formatos) {
		...
		try {	
			...
			String reporte = "002146RESUMENMENSUALAPORTESPENSION";
