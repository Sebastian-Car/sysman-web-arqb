/*-
 * EjecucionDeGastosSireciControlador.java
 *
 * 1.0
 *
 * 28/08/2017
...
import com.sysman.cgr.enums.EjecucionDeGastosSireciControladorUrlEnum;
...
/**
 * Calse que permite la generacion del archivo de excel de la
 * ejecucion de gastos Sireci.
 *
...
@ManagedBean
@ViewScoped
public class EjecucionDeGastosSireciControlador extends BeanBaseModal {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de EjecucionDeGastosSireciControlador
     */
    public EjecucionDeGastosSireciControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            numFormulario = GeneralCodigoFormaEnum.EJECUCION_DE_GASTOS_SIRECI_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
            ...
            listaAnoTrabajo = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            EjecucionDeGastosSireciControladorUrlEnum.URL4188
                                                                            .getValue())
                                            .getUrl(), param));
        }
