/*-
 * FinalidadgastosControlador.java
 *
 * 1.0
 *
 * 01/03/2017
...
/**
 * Formulario que lista la configuracion de la finalidad del gasto
 *
 * @version 1.0, 01/03/2017
 * @author eamaya
 *
 * @version 2.0, 18/09/2017 Se realiza refactoring a la clase.
 * @author jguerrero
 */
@ManagedBean
@ViewScoped
public class FinalidadgastosControlador extends BeanBaseContinuoAcmeImpl
{
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FinalidadgastosControlador
     */
    public FinalidadgastosControlador()
    {
        super();
        try
        {
    ...
    {
        enumBase = GenericUrlEnum.FINALIDAD_GASTO_SCHIP;
        buscarLlave();
