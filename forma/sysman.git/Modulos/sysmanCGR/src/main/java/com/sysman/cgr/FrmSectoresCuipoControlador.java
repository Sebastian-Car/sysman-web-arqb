/*-
 * FrmSectoresCuipoControlador.java
 *
 * 1.0
 * 
 * 18/06/2021
...
import com.sysman.cgr.enums.FrmSectoresCuipoControladorUrlEnum;
...
/**
 * Formulario que permite configurar los sectores cuipo
 *
...
public class FrmSectoresCuipoControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmSectoresCuipoControlador
     */
    public FrmSectoresCuipoControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            // 2298
            numFormulario = GeneralCodigoFormaEnum.FRM_SECTORES_CUIPO_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        enumBase = GenericUrlEnum.CUIPO_SECTORES;
        reasignarOrigen();
        buscarLlave();
            ...
            listaAnio = RegistroConverter.toListRegistro(requestManager.getList(
                            UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmSectoresCuipoControladorUrlEnum.URL4417
                                                                            .getValue())
                                            .getUrl(),
                            param));
        }
