/*-
 * FrmFuentesCuipoControlador.java
 *
 * 1.0
 * 
 * 21/06/2021
...
import com.sysman.cgr.enums.FrmFuentesCuipoControladorUrlEnum;
...
/**
 * Formulario que permite configurar las fuentes cuipo
 *
...
public class FrmFuentesCuipoControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmFuentesCuipoControlador
     */
    public FrmFuentesCuipoControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            // 2302
            numFormulario = GeneralCodigoFormaEnum.FRM_FUNTES_CUIPO_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        ...
        enumBase = GenericUrlEnum.CUIPO_FUENTES;
        reasignarOrigen();
        buscarLlave();
            ...
            listaAnio = RegistroConverter.toListRegistro(requestManager.getList(
                            UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmFuentesCuipoControladorUrlEnum.URL4226
                                                                            .getValue())
                                            .getUrl(),
                            param));
        }
