/*-
 * FrmSeccionPptalControlador.java
 *
 * 1.0
 * 
 * 18/06/2021
...
import com.sysman.cgr.enums.FrmSeccionPptalControladorUrlEnum;
...
/**
 * Formulario que permite la seccion pptal
 *
...
public class FrmSeccionPptalControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmSeccionPptalControlador
     */
    public FrmSeccionPptalControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            numFormulario = GeneralCodigoFormaEnum.FRM_SECCIONAL_PPTAL_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        ...
        enumBase = GenericUrlEnum.CUIPO_SECCION_PPTAL;
        reasignarOrigen();
        buscarLlave();
            ...
            listaAnio = RegistroConverter.toListRegistro(requestManager.getList(
                            UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmSeccionPptalControladorUrlEnum.URL4218
                                                                            .getValue())
                                            .getUrl(),
                            param));
        }
