/*-
 * FrmCodigoProductoCuipoControlador.java
 *
 * 1.0
 * 
 * 18/06/2021
...
import com.sysman.cgr.enums.FrmCodigoProductoCuipoControladorUrlEnum;
...
/**
 * Formulario que permite configurar los codigos de producto cuipo
 *
...
public class FrmCodigoProductoCuipoControlador
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmCodigoProductoCuipoControlador
     */
    public FrmCodigoProductoCuipoControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            // 2300
            numFormulario = GeneralCodigoFormaEnum.FRM_CODIGO_PRODUCTO_CUIPO_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        ...
        enumBase = GenericUrlEnum.CUIPO_CODIGO_PRODUCTO;
        reasignarOrigen();
        buscarLlave();
            ...
            listaAnio = RegistroConverter.toListRegistro(requestManager.getList(
                            UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmCodigoProductoCuipoControladorUrlEnum.URL3773
                                                                            .getValue())
                                            .getUrl(),
                            param));
        }
