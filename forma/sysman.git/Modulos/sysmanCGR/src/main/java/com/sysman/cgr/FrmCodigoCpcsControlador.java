...
import com.sysman.cgr.enums.FrmCodigoCpcsControladorUrlEnum;
...
/**
 * Formulario que permite configurar los codigos cuipo cpc
 *
...
public class FrmCodigoCpcsControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmCodigoCpcsControlador
     */
    public FrmCodigoCpcsControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            // 2294
            numFormulario = GeneralCodigoFormaEnum.FRM_CODIGO_CPC_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        enumBase = GenericUrlEnum.CUIPO_CODIGO_CPC_DANE;
        reasignarOrigen();
        buscarLlave();
            ...
            listaAnio = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmCodigoCpcsControladorUrlEnum.URL4321
                                                                            .getValue())
                                            .getUrl(), param));
        }
