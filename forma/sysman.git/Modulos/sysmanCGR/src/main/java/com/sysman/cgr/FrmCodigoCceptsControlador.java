/*-
 * FrmCodigoCceptsControlador.java
 *
 * 1.0
 * 
 * 17/06/2021
...
import com.sysman.cgr.enums.FrmCodigoCceptsControladorUrlEnum;
...
/**
 * Formulario que permite configurar los codigos cuipo ccept
 *
...
public class FrmCodigoCceptsControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmCodigoCceptsControlador
     */
    public FrmCodigoCceptsControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            // 2296
            numFormulario = GeneralCodigoFormaEnum.FRM_CODIGO_CCEPT_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        ...
        enumBase = GenericUrlEnum.CUIPO_CODIGO_CCEPT;
        reasignarOrigen();
        buscarLlave();
    ...
    public void reasignarOrigen() {
        ...
        parametrosListado.put(GeneralParameterEnum.ENTIDAD.getName(),
            ...
            listaAnio = RegistroConverter.toListRegistro(requestManager.getList(
                            UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmCodigoCceptsControladorUrlEnum.URL4396
                                                                            .getValue())
                                            .getUrl(),
                            param));
        }
