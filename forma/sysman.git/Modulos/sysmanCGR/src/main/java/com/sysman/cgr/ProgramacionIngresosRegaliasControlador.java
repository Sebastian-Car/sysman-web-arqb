/*-
 * ProgramacionIngresosRegaliasControlador.java
 *
 * 1.0
 *
 * 24/08/2017
...
import com.sysman.cgr.enums.ProgramacionIngresosRegaliasControladorUrlEnum;
...
/**
 * Clase que permite generar la programacion de ingresos de regalias.
 *
...
@ManagedBean
@ViewScoped
public class ProgramacionIngresosRegaliasControlador extends BeanBaseModal {
    /**
    ...
    /**
     * Valor del atributo correspondiente a anioTrabajo
     */
    ...
    // <DECLARAR_LISTAS>
    /**
     * Lista de objetos pertenecientes al combo Anio de Trabajo
     */
     ...
     * ProgramacionIngresosRegaliasControlador
     */
    public ProgramacionIngresosRegaliasControlador() {
        super();
        compania = SessionUtil.getCompania();
        codigoContaduria = SessionUtil.getCompaniaIngreso()
                        .getCodigoContaduria();
        try {
            numFormulario = GeneralCodigoFormaEnum.PROGRAMACION_INGRESOS_REGALIAS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
            ...
            listaAnoTrabajo = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            ProgramacionIngresosRegaliasControladorUrlEnum.URL4380
                                                                            .getValue())
                                            .getUrl(), param));
        }
        ...
        try {
            archivoDescarga = JsfUtil
                            .getArchivoDescarga(JsfUtil.serializarPlano(
                                            generarPlano(false)),
                                            "Programacion de ingresos Regalias.txt");
    ...
    public void oprimirGenerarExcel() {
        ...
        String nombreHoja = idioma.getString("TB_TB3717");
        String nombreDocumento = idioma.getString("TB_TB3718");
    ...
    /**
     * Genera archivo plano de programaci&oacute;n de ingresos
    ...
    private String generarPlano(boolean exportaExcel) {
        try {
            int ano = Integer.parseInt(anioTrabajo);
            return ejbCGRCero.generarPlanoProgramacionIngresosRegalias(compania,
                            ano, Integer.parseInt(trimestre),
