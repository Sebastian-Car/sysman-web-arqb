/*-
 * FrmProgramaCuipoControlador.java
 *
 * 1.0
 * 
 * 18/06/2021
...
import com.sysman.cgr.enums.FrmProgramaCuipoControladorUrlEnum;
...
/**
 * Formulario que permite configurar los programas cuipo
 *
...
public class FrmProgramaCuipoControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmProgramaCuipoControlador
     */
    public FrmProgramaCuipoControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            // 2299
            numFormulario = GeneralCodigoFormaEnum.FRM_PROGRAMA_CUIPO_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        ...
        enumBase = GenericUrlEnum.CUIPO_PROGRAMA;
        reasignarOrigen();
        buscarLlave();
            ...
            listaAnio = RegistroConverter.toListRegistro(requestManager.getList(
                            UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmProgramaCuipoControladorUrlEnum.URL4687
                                                                            .getValue())
                                            .getUrl(),
                            param));
        }
