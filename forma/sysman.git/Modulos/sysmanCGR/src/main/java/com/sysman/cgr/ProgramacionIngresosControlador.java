/*-
 * ProgramacionIngresosControlador.java
 *
 * 1.0
 *
 * 15/08/2017
...
import com.sysman.cgr.enums.ProgramacionIngresosControladorUrlEnum;
...
/**
 * Clase que permite la generacion del plano de la programación de
 * ingresos
 *
 * @version 1.0, 15/08/2017
 * @author jrodriguezr
 * @version 2.0, 18/08/2017 Se completa la funcionalidad del
 * formulario se realiza el llamado al EJB y Se realiza la
 * refactorizacion a DSS.
 */
@ManagedBean
@ViewScoped
public class ProgramacionIngresosControlador extends BeanBaseModal {
    /**
    ...
    // <DECLARAR_ATRIBUTOS>
    /**
     * Filtro del periodo en cual se genera el archivo plano
     */
    private String trimestre;
    /**
     * Filtro del ano en cual se genera el archivo plano
     */
    private String anioTrabajo;
    /**
     * Etiqueta que va en el plano
     */
    ...
    /**
     * Crea una nueva instancia de ProgramacionIngresosControlador
     */
    public ProgramacionIngresosControlador() {
        super();
        compania = SessionUtil.getCompania();
        codigoDetalle = SessionUtil.getCompaniaIngreso().getCodigoContaduria();
        try {
            numFormulario = GeneralCodigoFormaEnum.PROGRAMACION_INGRESOS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
            ...
            listaAnoTrabajo = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            ProgramacionIngresosControladorUrlEnum.URL4198
                                                                            .getValue())
                                            .getUrl(), param));
        }
        ...
        try {
            archivoDescarga = JsfUtil
                            .getArchivoDescarga(JsfUtil.serializarPlano(
                                            ejbCGRCero.generarPlanoProgramacionIngresos(
                                                            compania,
                                                            Integer.parseInt(
                                                                            anioTrabajo),
                                                            Integer.parseInt(
    ...
    public void oprimirExcel() {
        ...
        try {
            ...
            String archivoPlano = ejbCGRCero.generarPlanoProgramacionIngresos(
                            compania, Integer.parseInt(anioTrabajo),
                            Integer.parseInt(trimestre), codigoDetalle, true);
            String separadorRegistros = System.getProperty("line.separator");
            String separadorColumnas = "\t";
            String nombreHoja = "ingresos";
            String nombreDocumento = "Programacion de Ingresos";
