/*-
 * ProgramacionGastosRegaliasControlador.java
 *
 * 1.0
 *
 * 18/08/2017
...
import com.sysman.cgr.enums.ProgramacionGastosRegaliasControladorUrlEnum;
...
/**
 * Clase que permite generar el plano de la programacion de gastos de
 * regalias
 *
...
@ManagedBean
@ViewScoped
public class ProgramacionGastosRegaliasControlador extends BeanBaseModal {
    /**
     ...
     * ProgramacionGastosRegaliasControlador
     */
    public ProgramacionGastosRegaliasControlador() {
        super();
        ...
        try {
            // 1416
            numFormulario = GeneralCodigoFormaEnum.PROGRAMACION_GASTOS_REGALIAS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
            ...
            listaAnoTrabajo = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            ProgramacionGastosRegaliasControladorUrlEnum.URL4366
                                                                            .getValue())
                                            .getUrl(), param));
        }
        ...
        try {
            archivoDescarga = JsfUtil
                            .getArchivoDescarga(JsfUtil.serializarPlano(
                                            ejbCGRCero.generarPlanoProgramacionGastosRegalias(
                                                            compania,
                                                            Integer.parseInt(
                                                                            anio),
                                                            Integer.parseInt(
    ...
    public void oprimirEnviarExcel() {
        ...
        String nombreHoja = "PROGRAMACIÓN GASTOS REGALIAS";
        String nombreDocumento = "PROGRAMACIÓN GASTOS REGALIAS";
    ...
    private String generarPlano(boolean exportaExcel) {
        ...
        try {
            return ejbCGRCero.generarPlanoProgramacionGastosRegalias(compania,
                            Integer.parseInt(anio),
                            Integer.parseInt(trimestre), codigoContaduria,
                            codigoSGR, exportaExcel);
        }
