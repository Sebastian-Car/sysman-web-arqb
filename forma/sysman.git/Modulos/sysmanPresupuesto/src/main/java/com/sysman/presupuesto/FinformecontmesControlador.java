/*-
 * FinformecontmesControlador.java
 *
 * 1.0
 * 
 * 27/12/2019
...
import com.sysman.presupuesto.enums.FinformecontmesControladorUrlEnum;
import com.sysman.presupuesto.enums.FinformecontmesUrl;
...
@ManagedBean
@ViewScoped
public class  FinformecontmesControlador extends BeanBaseModal{
    /**
...
//<DECLARAR_LISTAS_COMBO_GRANDE>
 ...
 private EjbSysmanUtilRemote ejbSysmanUtil;
    ...
    public FinformecontmesControlador() {
    super();
	    ...
	    try {
            numFormulario = GeneralCodigoFormaEnum.FRM_EJECUCION_PRESUPUESTAL
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
        ...
        listaAno = RegistroConverter.toListRegistro(
                        requestManager.getList(UrlServiceUtil.getInstance()
                                        .getUrlServiceByUrlByEnumID(
                                        		FinformecontmesControladorUrlEnum.URL5047
                                                                        .getValue())
                                        .getUrl(), param));
    }
...
public void cargarListaMes(){
    ...
    try {
        listaMes = RegistroConverter.toListRegistro(
                        requestManager.getList(UrlServiceUtil.getInstance()
                                        .getUrlServiceByUrlByEnumID(
                                        		FinformecontmesControladorUrlEnum.URL5447
                                                                        .getValue())
                                        .getUrl(), param));
    }
    catch (SystemException e) {
...
public void cargarListaCuentaInicial(){
	...
	UrlBean urlBean = UrlServiceUtil.getInstance()
            .getUrlServiceByUrlByEnumID(
            		FinformecontmesControladorUrlEnum.URL6064
                                            .getValue());
Map<String, Object> param = new TreeMap<>();
param.put(GeneralParameterEnum.COMPANIA.getName(), compania);
...
public void cargarListaCuentaFinal(){
	...
	UrlBean urlBean = UrlServiceUtil.getInstance()
            .getUrlServiceByUrlByEnumID(
            		FinformecontmesControladorUrlEnum.URL7124
                                            .getValue());
Map<String, Object> param = new TreeMap<>();
param.put(GeneralParameterEnum.COMPANIA.getName(), compania);
param.put(GeneralParameterEnum.ANO.getName(), ano);
param.put(FinformecontmesUrl.CUENTAINICIAL
...
public void generarInforme(ReportesBean.FORMATOS formato) throws SystemException {
    String reporte = "002082FInformeContMes";
