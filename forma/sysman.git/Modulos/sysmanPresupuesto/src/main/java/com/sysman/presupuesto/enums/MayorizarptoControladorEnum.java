 ...
 */
public enum MayorizarptoControladorEnum {

    CODIN("CODIGOINICIAL"), PARAM1("PARAM1"), PARAM0("PARAM0");

    private final String value;

    private MayorizarptoControladorEnum(String value)
    {
        this.value = value;
    }
