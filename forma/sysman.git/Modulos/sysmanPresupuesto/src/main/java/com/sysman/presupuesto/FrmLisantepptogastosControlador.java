/*-
 * FrmLisantepptogastosControlador.java
 *
 * 1.0
 * 
 * 04/09/2020
...
import com.sysman.presupuesto.enums.FrmLisantepptogastosControladorUrlEnum;
...
@ManagedBean
@ViewScoped
public class FrmLisantepptogastosControlador extends BeanBaseModal
{
    /**
    ...
    /**
     * variable de lista de cuenta Inicial
     */
    private RegistroDataModelImpl listaCuentaFinal;

    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmLisantepptogastosControlador
     */
    public FrmLisantepptogastosControlador()
    {
        super();
        ...
        {
            // 2183
            numFormulario = GeneralCodigoFormaEnum.FRM_LIS_ANTE_PPTO_GASTOS_CONTROLADOR.getCodigo();
            validarPermisos();
    ...
    public void abrirFormulario()
    {
        // <CODIGO_DESARROLLADO>
        /*
         * FR2183-AL_ABRIR Private Sub Form_Open(Cancel As Integer) DoCmd.Restore End Sub
         */
        // </CODIGO_DESARROLLADO>
    }
            ...
            listaAno = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmLisantepptogastosControladorUrlEnum.URL001
                                                                            .getValue())
                                            .getUrl(), param));
        }
    ...
    public void cargarListaCuentaInicial()
    {
        ...
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        FrmLisantepptogastosControladorUrlEnum.URL002
                                                        .getValue());
        Map<String, Object> param = new TreeMap<>();
        param.put(GeneralParameterEnum.COMPANIA.getName(), compania);
    ...
    public void cargarListaCuentaFinal()
    {
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        FrmLisantepptogastosControladorUrlEnum.URL003
                                                        .getValue());
        Map<String, Object> param = new TreeMap<>();
        param.put(GeneralParameterEnum.COMPANIA.getName(), compania);
        param.put(GeneralParameterEnum.ANO.getName(), anio);
    ...
    public void generarInforme(ReportesBean.FORMATOS formato)
    {
        ...
        try
        {
            ...
            String reporte = "002143LISANTEPPTOGASTOS";
            ...
            parametros.put("PR_FORMS_LISANTEPPTOGASTOS_ANO", (anio));
