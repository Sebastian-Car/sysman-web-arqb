/*-
 * EjecucionIngresosMesControlador.java
 *
 * 1.0
 * 
 * 11/09/2018
...
import com.sysman.presupuesto.enums.EjecucionIngresosmesControladorUrlEnum;
...
/**
 * Formulario utilizado para ejecutar los ingresos del mes
 *
...
public class EjecucionIngresosMesControlador extends BeanBaseModal
{
    ...
    public EjecucionIngresosMesControlador()
    {
        super();
        ...
        try
        {
            numFormulario = GeneralCodigoFormaEnum.EJECUCION_INGRESOS_MES_CONTROLADOR.getCodigo();
            validarPermisos();
            ...
            listaAno = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            EjecucionIngresosmesControladorUrlEnum.URL0007
                                                                            .getValue())
                                            .getUrl(), param));
        }
    ...
    public void cargarListaMes()
    {
        ...
        try
        {
            listaMes = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            EjecucionIngresosmesControladorUrlEnum.URL0016
                                                                            .getValue())
                                            .getUrl(), param));
        }
        catch (SystemException e)
    ...
    public void cargarListaCuentaInicial()
    {
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(EjecucionIngresosmesControladorUrlEnum.URL0022.getValue());
    ...
    {
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(EjecucionIngresosmesControladorUrlEnum.URL0024.getValue());
    ...
    public void generaEXCEL(FORMATOS formato)
    {
        ...
        strSql = "800193EjecucionIngresosMes";
        ...
        try (ByteArrayOutputStream out = new ByteArrayOutputStream())
        {
            ...
            cell1.setCellValue("EJECUCION PRESUPUESTAL DE INGRESOS DETALLADA MES");
            ...
            archivoDescarga = JsfUtil.getArchivoDescarga(
                            new ByteArrayInputStream(out.toByteArray()), "IngresosMensualizado.xlsx");
            workbook.close();
