/*-
 * AsignacionrecursosControlador.java
 *
 * 1.0
 * 
 * 11/01/2017
...
@ManagedBean
@ViewScoped
public class AsignacionrecursosControlador extends BeanBaseContinuoAcmeImpl
{
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de AsignacionrecursosControlador
     */
    public AsignacionrecursosControlador()
    {
        super();
        compania = SessionUtil.getCompania();
        try
        {
            numFormulario = GeneralCodigoFormaEnum.ASIGNACIONRECURSOS_CONTROLADOR.getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
        }
    ...
    public void inicializar()
    {
        ...
        enumBase = GenericUrlEnum.ASIGNACION_RECURSOS;
        buscarLlave();
        reasignarOrigen();
