/*-
 * FrmIngretrimestreControlador.java
 *
 * 1.0
 * 
 * 30/10/2020
...
import com.sysman.presupuesto.enums.FrmIngretrimestreControladorUrlEnum;
 ...
 * @author avega-Se refactoriza y conexiones de 
 * igual forma se documenta y ajusta las alertas de sonar.
 * 
 */
@ManagedBean
@ViewScoped
public class FrmIngretrimestreControlador extends BeanBaseModal
{
    /**
     * Constante a nivel de clase que almacena el codigo de la compania
     *  en la cual inicio sesion el usuario, el valor de esta constante 
    ...
    /**
     * variable que almacena la lista de ano
     */
    private RegistroDataModelImpl listaCuentaInicial;
    /**
     * variable que almacena la lista de cuenta Inicial
     */
    private RegistroDataModelImpl listaCuentaFinal;

    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmIngretrimestreControlador
     */
    public FrmIngretrimestreControlador()
    {
        super();
        ...
        {
            // 2208
            numFormulario = GeneralCodigoFormaEnum.FRM_INGRETRIMESTRE_CONTROLADOR.getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
        }
    ...
    public void abrirFormulario()
    {
        // <CODIGO_DESARROLLADO>
        /*
         * FR2208-AL_ABRIR Private Sub Form_Open(Cancel As Integer) DoCmd.Restore End Sub
         */
        // </CODIGO_DESARROLLADO>
    }
            ...
            listaAno = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            FrmIngretrimestreControladorUrlEnum.URL001
                                                                            .getValue())
                                            .getUrl(), param));
        }
    ...
    public void cargarListaCuentaInicial()
    {
        ...
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        FrmIngretrimestreControladorUrlEnum.URL002
                                                        .getValue());
        Map<String, Object> param = new TreeMap<>();
        param.put(GeneralParameterEnum.COMPANIA.getName(), compania);
    ...
    public void cargarListaCuentaFinal()
    {
        UrlBean urlBean = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        FrmIngretrimestreControladorUrlEnum.URL003
                                                        .getValue());
        Map<String, Object> param = new TreeMap<>();
        param.put(GeneralParameterEnum.COMPANIA.getName(), compania);
        param.put(GeneralParameterEnum.ANO.getName(), anio);
    ...
    public void generarInforme(ReportesBean.FORMATOS formato)
    {
        ...
        try
        {
            String reporte = "002141INFINGRETRIMESTREP";
