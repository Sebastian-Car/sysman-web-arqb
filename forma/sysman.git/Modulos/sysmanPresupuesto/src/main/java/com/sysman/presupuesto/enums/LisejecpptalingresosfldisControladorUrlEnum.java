/*
 * LisejecpptalingresosfldisControladorUrlEnum
 *
 * 1.0
 *
 * 21/10/2020
 ...
 */
public enum LisejecpptalingresosfldisControladorUrlEnum {
	...
	private LisejecpptalingresosfldisControladorUrlEnum(String key, String value) {
		this.key = key;
		this.value = value;
	}
