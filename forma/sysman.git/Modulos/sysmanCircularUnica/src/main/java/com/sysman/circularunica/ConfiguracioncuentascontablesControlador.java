/*-
 * ConfiguracioncuentascontablesControlador.java
 *
 * 1.0
 * 
 * 09/07/2018
...
import com.sysman.circularunica.enums.ConfiguracioncuentascontablesControladorUrlEnum;
...
@ManagedBean
@ViewScoped
public class ConfiguracioncuentascontablesControlador
     ...
     * ConfiguracioncuentascontablesControlador
     */
    public ConfiguracioncuentascontablesControlador() {
        super();
    ...
    public void reasignarOrigen() {
        urlListado = UrlServiceUtil.getInstance().getUrlServiceByUrlByEnumID(
                        ConfiguracioncuentascontablesControladorUrlEnum.URL001
                                        .getValue());

        urlActualizacion = UrlServiceUtil.getInstance()
                        .getUrlServiceByUrlByEnumID(
                                        ConfiguracioncuentascontablesControladorUrlEnum.URL003
                                                        .getValue());
        ...
        try {
            listaCbAno = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            ConfiguracioncuentascontablesControladorUrlEnum.URL002
                                                                            .getValue())
                                            .getUrl(), param));
        }
