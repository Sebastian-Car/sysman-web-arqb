/*-
 * PlancircularunicasControlador.java
 *
 * 1.0
 * 
 * 29/06/2018
...
import com.sysman.circularunica.enums.PlanCircularUnicaControladorUrlEnum;
...
@ManagedBean
@ViewScoped
public class PlancircularunicasControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    /**
     * variable que almacena la lista del combo listaCbAno
     */
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de PlancircularunicasControlador
     */
    public PlancircularunicasControlador() {
        super();
        ...
        try {
            ...
            numFormulario = GeneralCodigoFormaEnum.PLAN_CIRCULAR_UNICA
                            .getCodigo();
    ...
    public void inicializar() {
        enumBase = GenericUrlEnum.PLAN_CIRCULAR_UNICA;
        reasignarOrigen();
        buscarLlave();
            ...
            listaCbAno = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            PlanCircularUnicaControladorUrlEnum.URL001
                                                                            .getValue())
                                            .getUrl(), param));
        }
    ...
    /**
     * 
     * Metodo ejecutado al oprimir el boton BtnPrepararCodigos en la
     * vista
     *
     */
    public void oprimirBtnPrepararCodigos() {
        // <CODIGO_DESARROLLADO>
        String[] campos = { "anioInicial", "opcion" };
        String[] valores = { String.valueOf(anio), "1" };
