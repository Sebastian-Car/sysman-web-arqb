/*-
 * ValorizacionConceptosControlador.java
 *
 * 1.0
 * 
 * 08/03/2019
...
@ManagedBean
@ViewScoped
public class ValorizacionConceptosControlador extends BeanBaseDatosAcmeImpl {
    /**
    ...
    // </DECLARAR_ADICIONALES>
    /**
     * Crea una nueva instancia de ValorizacionConceptosControlador
     */
    public ValorizacionConceptosControlador() {
        super();
        ...
        encabezado = idioma.getString("TB_TB4291");
        ...
        try {
            numFormulario = GeneralCodigoFormaEnum.VALORIZACION_CONCEPTOS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
