/*-
 * FrminfrecursosnaturalesControlador.java
 *
 * 1.0
 * 
 * 12/05/2026
...
@ManagedBean
@ViewScoped
public class  FrminfrecursosnaturalesControlador extends BeanBaseModal{
	/**
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrminfrecursosnaturalesControlador
	 */
	public FrminfrecursosnaturalesControlador() {
		super();
		compania = SessionUtil.getCompania();
		modulo = SessionUtil.getModulo();
		try {
			numFormulario = GeneralCodigoFormaEnum.FRM_INF_RECURSOS_NATURALES
                    .getCodigo();
			validarPermisos();
			//<INI_ADICIONAL>
			//</INI_ADICIONAL>
	...
	public void generarInforme(ReportesBean.FORMATOS formato) {
        ...
        try {
            ...
            if ("1".equals(agrupadoPor)) {
            	informe = "002935InversionRecursosNaturalesAgru";
            } else {
            	informe = "002934InversionRecursosNaturalesDet";
            }
