/*-
 * MantenimientoPlanDesarrolloControlador.java
 *
 * 1.0
 * 
 * 02/08/2021
...
import com.sysman.plandesarrollo.enums.MantenimientoPlanDesarrolloControladorUrlEnum;
...
@ManagedBean
@ViewScoped
public class MantenimientoPlanDesarrolloControlador extends BeanBaseModal {
	/**
    ...
    /**
     * Atributo que almacena el numero del mes seleccionado en el
     * combo de mes
     */
	...
	/**
	 * Crea una nueva instancia de MantenimientoPlanDesarrolloControlador
	 */
	public MantenimientoPlanDesarrolloControlador() {
		super();
		compania = SessionUtil.getCompania();
		try {
			numFormulario = GeneralCodigoFormaEnum.MANTENIMIENTO_PLAN_DE_DESARROLLO_CONTROLADOR.getCodigo();
			validarPermisos();
			//<INI_ADICIONAL>
			//</INI_ADICIONAL>
		} catch (Exception ex) {
            ...
            listaVigencia = RegistroConverter.toListRegistro(
                            requestManager.getList(UrlServiceUtil.getInstance()
                                            .getUrlServiceByUrlByEnumID(
                                                            MantenimientoPlanDesarrolloControladorUrlEnum.URL124
                                                                            .getValue())
                                            .getUrl(), param));
        }
	...
	public void oprimirAceptar() {
		 // <CODIGO_DESARROLLADO>
        try {
            planDesarrolloDos.actualizarPresupuestoPlanDesarrollo(compania,
