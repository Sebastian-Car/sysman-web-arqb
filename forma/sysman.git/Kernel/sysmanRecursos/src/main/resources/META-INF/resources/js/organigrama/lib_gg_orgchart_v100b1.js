...
( function (window, undefined) {
    ...
    window.ggOrgChart = {
        ...
        //
        render: function (options, json_file,json)
        {
            ...
            return oc_render(options, json_file,json);
        },
    ...
    // 
    function oc_render (this_options, this_json_file,json)
    {
    ...
    function oc_draw_obj (options, node, parent, xoffset, yoffset, xoffset2) 
    {
        ...
        if (typeof node.visible == "undefined" || node.visible === true) {
            ...
            box.attr('fill', node.subtype == 'dashed' ? options.dashed_box_color : node.color_nodo );
        ...
        if (typeof options.box_html_template == "string") {
            ...
            var event_box_color       = node.subtype == 'dashed' ? options.dashed_box_color       : node.color_nodo;
