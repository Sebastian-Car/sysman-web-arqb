...
/**
 * Formulario continuo llamada monitor de indicadores basicos que pertmite obtener informacion del formulario indicadores basicos.
 *
...
@ManagedBean
@ViewScoped
public class MonitorinControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de MonitorinControlador
     */
    public MonitorinControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            numFormulario = GeneralCodigoFormaEnum.MONITOR_IN_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        enumBase = GenericUrlEnum.IG_DETALLE_INDICADORES_BASICOS;
        reasignarOrigen();
        buscarLlave();
