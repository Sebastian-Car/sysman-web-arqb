/*-
 * FcorreossalidasControlador.java
 *
 * 1.0
 * 
 * 22/06/2018
...
/**
 * Formulario continuo que permite la generacion de correos de salida.
 *
...
@ManagedBean
@ViewScoped
public class FcorreossalidasControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FcorreossalidasControlador
     */
    public FcorreossalidasControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            numFormulario = GeneralCodigoFormaEnum.FCORREOSSALIDA_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        enumBase = GenericUrlEnum.CORREOS_SALIDA;
        reasignarOrigen();
        buscarLlave();
    ...
    public void abrirFormulario() {
        // <CODIGO_DESARROLLADO>
        /*
         * FR1839-AL_ABRIR Private Sub Form_Open(Cancel As Integer) DoCmd.Maximize End Sub
         */
        // </CODIGO_DESARROLLADO>
    }
    ...
    public boolean insertarAntes() {
        ...
        if (SysmanFunciones.validarEmail(
                        registro.getCampos().get("CORREO_SALIDA")
                                        .toString()))
            ;
        else {
