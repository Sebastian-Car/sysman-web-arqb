...
import com.sysman.general.enums.FrmtiponovedadtecnicasControladorEnum;
...
public class FrmtiponovedadtecnicasControlador
    ...
    public FrmtiponovedadtecnicasControlador() {
        ...
        try {
            ...
            Logger.getLogger(FrmtiponovedadtecnicasControlador.class.getName())
    ...
    public void removerCombos() {
        registro.getCampos().remove(FrmtiponovedadtecnicasControladorEnum.CODIGO
                        .getValue());
        registro.getCampos().remove(FrmtiponovedadtecnicasControladorEnum.TIPOLB
                        .getValue());
