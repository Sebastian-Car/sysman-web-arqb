...
import com.sysman.general.enums.FrmIndBasicosControladorUrlEnum;
...
/**
 * Fomrulario continuo que permite insertar indicadores basicos.
 *
...
@ManagedBean
@ViewScoped
public class FrmindbasicosControlador extends BeanBaseContinuoAcmeImpl {
    /**
    ...
    // </DECLARAR_LISTAS_COMBO_GRANDE>
    /**
     * Crea una nueva instancia de FrmindbasicosControlador
     */
    public FrmindbasicosControlador() {
        super();
        compania = SessionUtil.getCompania();
        try {
            numFormulario = GeneralCodigoFormaEnum.FRM_INDBASICOS_CONTROLADOR
                            .getCodigo();
            validarPermisos();
            // <INI_ADICIONAL>
            // </INI_ADICIONAL>
    ...
    public void inicializar() {
        enumBase = GenericUrlEnum.IG_INDICADORES_BASICOS;
        reasignarOrigen();
        buscarLlave();
    ...
    public void abrirFormulario() {
        // <CODIGO_DESARROLLADO>
        /*
         * FR1954-AL_ABRIR Private Sub Form_Open(Cancel As Integer) DoCmd.Maximize End Sub
         */
        // </CODIGO_DESARROLLADO>
    }
