...
@ManagedBean
@ViewScoped
public class  FrmSfUnidadControlador  extends BeanBaseContinuoAcmeImpl{
	/**
	...
	//</DECLARAR_LISTAS_COMBO_GRANDE>
	/**
	 * Crea una nueva instancia de FrmSfUnidadControlador
	 */
	public FrmSfUnidadControlador() {
		super();
