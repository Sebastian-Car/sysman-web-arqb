 ...
 */
@XmlRootElement
public class RespuestaRangoFacturacion {
    /**
     ...
     * diferente de 0
     */
    private List<RespuestaCuerpoRangoFacturacion> cuerpo;
     ...
     */
    public RespuestaRangoFacturacion() {
        cuerpo = null;
        codigo = 0;
        mensaje = "OK";
    }
    ...
    public List<RespuestaCuerpoRangoFacturacion> getCuerpo() {
        return cuerpo;
    }

    public void setCuerpo(List<RespuestaCuerpoRangoFacturacion> cuerpo) {
        this.cuerpo = cuerpo;
    }
