 ...
 */
@XmlRootElement
public class RespuestaRangoFactDian {
    /**
     ...
     * diferente de 0
     */
    RespuestaCuerpoRangoFactDian cuerpo;
    ...
    public RespuestaCuerpoRangoFactDian getCuerpo() {
        return cuerpo;
    }

    public void setCuerpo(RespuestaCuerpoRangoFactDian cuerpo) {
        this.cuerpo = cuerpo;
    }
