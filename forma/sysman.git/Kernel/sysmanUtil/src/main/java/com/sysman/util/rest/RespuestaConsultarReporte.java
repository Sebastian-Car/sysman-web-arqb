 ...
 */
@XmlRootElement
public class RespuestaConsultarReporte {
    /**
     ...
     * diferente de 0
     */
    private RespuestaCuerpoConsultarReporte cuerpo;
     ...
     */
    public RespuestaConsultarReporte() {
        cuerpo = null;
        codigo = 0;
        mensaje = "OK";
    }
    ...
    public RespuestaCuerpoConsultarReporte getCuerpo() {
        return cuerpo;
    }

    public void setCuerpo(RespuestaCuerpoConsultarReporte cuerpo) {
        this.cuerpo = cuerpo;
    }
