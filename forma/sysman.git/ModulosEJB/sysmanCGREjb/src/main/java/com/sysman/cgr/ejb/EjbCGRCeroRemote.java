...
@Remote
public interface EjbCGRCeroRemote {
	...
	String actualizarTipoClasificadorRubro(String compania, int ano, String naturaleza, String cadenaplan, String usuario) throws SystemException;

	String actclaApropiaciones(String compania, String ano, String cadenaplan, String usuario) throws SystemException;
