...
@Remote
public interface EjbPlusvaliaCeroRemote {
    ...
    String procesoFacturacionCopia(String compania,
        long idProyecto,
    ...
    String crearAcuerdo(String compania,
        long idProyecto, long idFactura,
        long idBeneficiario,
        ...
        String usuario,
        boolean preliquidar) throws SystemException;;
