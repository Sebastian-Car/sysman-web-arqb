...
@Remote
public interface EjbFacturacionGeneralCeroRemote {
    ...
    BigDecimal retonarTasaAnual(String compania, int anio, String tipocobro, Date fechacorte) throws SystemException;
