...
@Remote
public interface EjbFacturacionGeneralTresRemote {
    ...
    BigDecimal obtenerValorNetoAnterior(
            ...
            BigInteger codigoCobro)
                    throws SystemException;
    boolean eliminarDetallesContratoParametrizado(String compania, String tipo, String numero) throws SystemException;
}