...
@Remote
public interface EjbNominaSieteRemote
{
    ...
    void almacenarCesantiasAuto(String compania, int preoceso, String idEmpleado, int ano, int mes, int periodo, String usuario) throws SystemException;
    
    String getArmarConsultatDevengosDescuentos(
            String compania,
            String ano,
            String mes,
            String proceso,
