...
@Remote
public interface EjbContabilidadCeroRemote {
    ...
    String cambiarFechaComprobante(
            String compania,
            String anio,
	...
	void perpararDatosAjusteFiscal(String compania, String anoFiscal, String mesFiscal) throws SystemException;
