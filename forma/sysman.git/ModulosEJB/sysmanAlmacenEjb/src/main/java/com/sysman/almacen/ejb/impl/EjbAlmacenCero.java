...
import com.sysman.almacen.ejb.EjbAlmacenCeroLocal;
...
/**
 * Session Bean implementation class AlmacenCero jgomez 10/06/2017. Implementacion metodo concatenar de la clase SysmanFunciones para el envio de parametros a los diferentes procedimientos y
 * funciones.
 */
@Stateless
@LocalBean
public class EjbAlmacenCero
                implements EjbAlmacenCeroRemote, EjbAlmacenCeroLocal
{
    /**
     * Default constructor.
     */
    public EjbAlmacenCero()
    {
    }
