...
@Local
public interface EjbSysmanUtilLocal {
	...
	int consultarModeloAno(String compania
            , String ano) throws SystemException;
	
	int aplicacionCuenta(String compania
            , String ano
            , String codigo
            , String cuenta) throws SystemException;
	
	String cuentaClasificador(String compania
            , String ano
            , String cuenta
            , String clase) throws SystemException;
