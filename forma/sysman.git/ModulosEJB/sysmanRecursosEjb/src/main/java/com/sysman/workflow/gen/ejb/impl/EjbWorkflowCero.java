package com.sysman.workflow.gen.ejb.impl;

import com.sysman.exception.SystemException;
import com.sysman.persistencia.AccionesImp;
import com.sysman.persistencia.ConectorPool;
import com.sysman.util.SysmanFunciones;
import com.sysman.workflow.gen.ejb.EjbWorkflowCeroLocal;
...
public class EjbWorkflowCero
    ...
    public BigInteger workflow_pqrs(
        ...
        String[] parametros = { "UN_COMPANIA          =>'", compania, "', ",
                                ...
                                "UN_DESCRIPCION_SOLICITUD =>'", descripcion, "', ",
                                "UN_EMAIL =>'", email, "', ",
                                "UN_ANEXO1 =>'", anexo1, "', ",
                                "UN_ANEXO2 =>'", anexo2, "', ",
                                "UN_ANEXO3 =>'", anexo3, "', ",
                                "UN_TELEFONO =>'", telefono, "', ",
                                "UN_GENERO =>'", genero, "', ",
                                "UN_CODIGO_TRAMITE=>'", codigoTramite, "', ", 
                                "UN_TIPO_TRAMITE_USUARIO =>'", tipoTramiteUsuario, "', ",
                                "UN_RANGO_EDAD =>'", rangoEdad, "', ",
                                "UN_TIPO_PERSONA =>'", tipoPersona, "', ",
                                "UN_TIPO_POBLACION =>'", tipoPoblacion, "', ",
                                "UN_VULNERABILIDAD =>'", vulnerabilidad, "', ",
                                "UN_OCUPACION =>'", ocupacion, "', ",
                                "UN_ESCOLARIDAD =>'", escolaridad, "', ",
                                "UN_DES_TIPO_POBLACION =>'", desTipoPoblacion, "', ",
                                "UN_DES_OCUPACION =>'", desOcupacion, "', ",
                                "UN_ANONIMO =>'", (anonimo ? "-1" : "0"), "'"
        };
        return new BigInteger( AccionesImp.ejecutarFuncion(
		        ConectorPool.ESQUEMA_SYSMAN,
		        "PCK_WORKFLOW.FC_WORKFLOW_PQRS",
		        SysmanFunciones.concatenar(parametros),
		        Types.BIGINT).toString());
	...
	public int tramitarAProceso(String compania, String proceso, String tipoTramite, BigInteger numero,
			...
			String descripcion, String tipoTramiteUsuario, String telefono, String genero,String codigoTramite) throws SystemException {
