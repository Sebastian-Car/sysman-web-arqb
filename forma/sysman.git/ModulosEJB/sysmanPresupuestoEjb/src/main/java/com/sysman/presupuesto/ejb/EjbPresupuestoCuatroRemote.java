/*-
 * EjbPresupuestoCuatroRemote.java
 *
 * 1.0
 * 
 * 4 jul. 2019
...
@Remote
public interface EjbPresupuestoCuatroRemote {
	...
	void cargarClasificadorHijo(String compania, String cadenaplan, String usuario) throws SystemException;
